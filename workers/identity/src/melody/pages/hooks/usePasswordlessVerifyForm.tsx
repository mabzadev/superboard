...
const usePasswordlessVerifyForm = ({
	...
	const handleChange = (name: "mfaCode", value: string[]) => {
		onSubmitError(null);
		setMfaCode(value);
	};
	...
	const sendPasswordlessCode = useCallback(
		(isResend: boolean = false) => {
			setIsSending(true);
			fetch(routeConfig.IdentityRoute.SendPasswordlessCode, {
				method: "POST",
				headers: {
	...
	const handleSubmit = useCallback(
		(e: Event) => {
			...
			fetch(routeConfig.IdentityRoute.ProcessPasswordlessCode, {
				method: "POST",
				headers: {
					Accept: "application/json",
					"Content-Type": "application/json",
