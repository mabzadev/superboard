...
import { DELETE, GET, PATCH, POST } from "../../transport.js";
...
export const updateLinkAPICall = async (
	...
	return PATCH(config.apiPath + `/projects/${instanceId}/links/${linkId}`, formData);
};
...
export const availablePathAPICall = async (
	...
	return POST(config.apiPath + `/projects/${instanceId}/links/check_path`, data);
};
