...
import type { Link, GetLinksParams, LinksByIdsPayload } from "@superboard/front-ui/types";
...
} from "../../api/links/linksService.js";
...
export function useLinksListQuery(projectId: string | undefined, params: GetLinksParams | null) {
...
export function useLinksByIdsQuery(projectId: string | undefined, ids: LinksByIdsPayload | null) {
	return useQuery({
...
export function usePathAvailableQuery(projectId: string | undefined, path: string | undefined) {
	return useQuery({
...
export function useRandomPathQuery(projectId: string | undefined, enabled: boolean = false) {
	return useQuery({
