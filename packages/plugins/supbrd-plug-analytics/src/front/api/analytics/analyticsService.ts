...
export type SavedAnalyticsReport = {
	id: string;
	report_type: "dashboard" | "funnel" | "cohort" | "retention" | "query" | "alert";
	name: string;
...
function query(filters: Partial<AnalyticsRange> & Record<string, string | undefined>) {
...
export async function getAnalyticsOverview(projectRef: string, filters: AnalyticsRange) {
	return data<AnalyticsOverview>(await GET(path(projectRef, `/overview${query(filters)}`)));
}
...
export async function getAnalyticsInstallations(projectRef: string, filters: AnalyticsRange) {
	return data<{ items: AnalyticsInstallation[] }>(
		await GET(path(projectRef, `/installations${query(filters)}`)),
	);
}

export async function getAnalyticsPurchases(projectRef: string, filters: AnalyticsRange) {
...
export async function queryAnalyticsFunnel(
	...
	return data<FunnelResult>(await POST(path(projectRef, "/funnels/query"), payload));
}
...
export async function getAnalyticsRetention(
	...
	return data<RetentionResult>(await GET(path(projectRef, `/retention${query(filters)}`)));
}

export async function getAnalyticsReports(projectRef: string) {
	return data<{ items: SavedAnalyticsReport[] }>(await GET(path(projectRef, "/reports")));
}
...
export async function createAnalyticsReport(
	...
	return data<SavedAnalyticsReport>(await POST(path(projectRef, "/reports"), payload));
}
...
export async function updateAnalyticsReport(
	...
	return data<SavedAnalyticsReport>(await PUT(path(projectRef, `/reports/${id}`), payload));
}

export async function deleteAnalyticsReport(projectRef: string, id: string) {
	return data<{ id: string; deleted: boolean }>(await DELETE(path(projectRef, `/reports/${id}`)));
}

export async function getAnalyticsOperations(projectRef: string) {
	return data<{ items: AnalyticsOperation[] }>(await GET(path(projectRef, "/operations")));
}
...
export async function createAnalyticsOperation(
	...
	return data<AnalyticsOperation>(await POST(path(projectRef, "/operations"), payload));
}

export async function getAnalyticsApplications(projectRef: string) {
	return data<{ items: AnalyticsApplication[] }>(await GET(path(projectRef, "/applications")));
}

export async function updateAnalyticsApplication(
	projectRef: string,
	applicationId: string,
	payload: Partial<Pick<AnalyticsApplication, "name" | "timezone" | "active" | "settings">>,
) {
...
export async function getAnalyticsDashboards(projectRef: string) {
	return data<{ items: AnalyticsDashboard[] }>(await GET(path(projectRef, "/dashboards")));
}

export async function getAnalyticsDashboard(projectRef: string, id: string) {
	return data<AnalyticsDashboard>(await GET(path(projectRef, `/dashboards/${id}`)));
}
...
export async function createAnalyticsDashboard(
	...
	return data<AnalyticsDashboard>(await POST(path(projectRef, "/dashboards"), payload));
}

export async function updateAnalyticsDashboard(
	projectRef: string,
	id: string,
	payload: Partial<Pick<AnalyticsDashboard, "name" | "description" | "visibility" | "layout">>,
) {
	return data<AnalyticsDashboard>(await PUT(path(projectRef, `/dashboards/${id}`), payload));
}
...
export async function deleteAnalyticsDashboardWidget(
	...
	return data<{ id: string; deleted: boolean }>(
		await DELETE(path(projectRef, `/dashboards/${dashboardId}/widgets/${widgetId}`)),
	);
}

export async function getAnalyticsSessions(projectRef: string, filters: AnalyticsRange) {
...
export async function getAnalyticsProfiles(projectRef: string) {
	return data<{ items: AnalyticsProfile[] }>(await GET(path(projectRef, "/profiles")));
}

export async function getAnalyticsViews(projectRef: string, filters: AnalyticsRange) {
	return data<{ items: AnalyticsView[]; from: string; to: string }>(
		await GET(path(projectRef, `/views${query(filters)}`)),
	);
}

export async function getAnalyticsDimensions(projectRef: string, filters: AnalyticsRange) {
	return data<{
...
export async function getAnalyticsCrash(projectRef: string, fingerprint: string) {
...
export async function updateAnalyticsCrash(
	...
	return data<AnalyticsCrash>(
		await PUT(path(projectRef, `/crashes/${encodeURIComponent(fingerprint)}`), payload),
	);
}
...
export async function getAnalyticsCohorts(projectRef: string) {
	return data<{ items: AnalyticsCohort[] }>(await GET(path(projectRef, "/cohorts")));
}
...
export async function createAnalyticsCohort(
	...
	return data<AnalyticsCohort>(await POST(path(projectRef, "/cohorts"), payload));
}

export async function evaluateAnalyticsCohort(projectRef: string, id: string) {
	return data<AnalyticsCohort>(await POST(path(projectRef, `/cohorts/${id}/evaluate`), {}));
}

export async function deleteAnalyticsCohort(projectRef: string, id: string) {
	return data<{ id: string; deleted: boolean }>(await DELETE(path(projectRef, `/cohorts/${id}`)));
}

export async function getAnalyticsRemoteConfig(projectRef: string) {
	return data<{ items: AnalyticsRemoteConfig[] }>(await GET(path(projectRef, "/remote-config")));
}
...
export async function upsertAnalyticsRemoteConfig(
	...
	return data<AnalyticsRemoteConfig>(
		await PUT(path(projectRef, `/remote-config/${encodeURIComponent(key)}`), payload),
	);
}
...
export async function deleteAnalyticsRemoteConfig(
	...
	return data<{ id: string; deleted: boolean }>(
		await DELETE(
			path(projectRef, `/remote-config/${encodeURIComponent(key)}?environment=${environment}`),
		),
	);
}
...
export async function deleteAnalyticsAlert(projectRef: string, id: string) {
	return data<{ id: string; deleted: boolean }>(await DELETE(path(projectRef, `/alerts/${id}`)));
}

export async function getAnalyticsHooks(projectRef: string) {
	return data<{ items: AnalyticsHook[] }>(await GET(path(projectRef, "/hooks")));
}
...
export async function deleteAnalyticsHook(projectRef: string, id: string) {
	return data<{ id: string; deleted: boolean }>(await DELETE(path(projectRef, `/hooks/${id}`)));
}

export async function getAnalyticsAnnotations(projectRef: string) {
	return data<{ items: AnalyticsAnnotation[] }>(await GET(path(projectRef, "/annotations")));
}
...
export async function createAnalyticsAnnotation(
	...
	return data<AnalyticsAnnotation>(await POST(path(projectRef, "/annotations"), payload));
}

export async function deleteAnalyticsAnnotation(projectRef: string, id: string) {
	return data<{ id: string; deleted: boolean }>(
...
export async function updateAnalyticsSettings(
	...
	return data<AnalyticsSettings>(await PUT(path(projectRef, "/settings"), payload));
}
