...
import type { useCreateLinkForm } from "../../../../hooks/useCreateLinkForm.js";
import CreateLinkDataSection from "./CreateLinkDataSection.js";
import CreateLinkDetailsSection from "./CreateLinkDetailsSection.js";
import CreateLinkSidebar from "./CreateLinkSidebar.js";
import CreateLinkSocialMediaPreview from "./CreateLinkSocialMediaPreview.js";
import CreateLinksRedirectsSection from "./CreateLinksRedirectsSection.js";
import CreateLinkTrackingSection from "./CreateLinkTrackingSection.js";
...
const LinkDialogContent: React.FC<LinkDialogContentProps> = ({
	...
	return (
		<div className="flex h-full w-full overflow-hidden">
			<CreateLinkSidebar sections={sections} section={section} setSection={setSection} />
			{section === "details" && (
