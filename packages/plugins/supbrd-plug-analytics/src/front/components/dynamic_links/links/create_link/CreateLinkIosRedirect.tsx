...
const CreateLinkIosRedirect = React.memo(function CreateLinkIosRedirect({
	...
	const hasError = iosRedirectType !== DEFAULT && url.length > 0 && (!urlIsValid || !isHttps);
	const showUrlValid = iosRedirectType !== DEFAULT && urlIsValid && isHttps;
	const showEmptyError = showErrors && iosRedirectType !== DEFAULT && url.length === 0;
	const errorMessage =
				...
				<>
					...
					<div className="flex flex-col gap-1.5 ">
						<label className="text-sm font-medium">
							{iosRedirectType === APP_OR_FALLBACK ? "Fallback URL" : "Redirect URL"}
						</label>
