...
export default centralTests(
	...
	defineConfig({
				...
				miniflare: {
					bindings: {
						...
						TEST_MIGRATIONS: await readD1Migrations(
							fileURLToPath(new URL("../../supbrd-core/api/migrations", import.meta.url)),
						),
					},
					serviceBindings: {
		...
		test: {
			include: [
				"../../../../tests/checks/plugins/supbrd-plug-commerce/billing/runtime/**/*.test.ts",
			],
			setupFiles: [
				"../../../../tests/checks/plugins/supbrd-plug-commerce/billing/runtime/apply-migrations.ts",
			],
		},
	}),
);
