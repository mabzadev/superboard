...
import { usePostApiV1AppBannersMutation } from "../../../../../../../identity/services/auth/api.js";
...
const Page = () => {
	...
	const { values, errors, onChange } = useEditBanner(undefined);
				...
				<Table>
					...
					<TableBody className="divide-y">
						<TableRow>
							...
							<TableCell>
								<BannerTypeSelector value={values.type} onChange={(val) => onChange("type", val)} />
