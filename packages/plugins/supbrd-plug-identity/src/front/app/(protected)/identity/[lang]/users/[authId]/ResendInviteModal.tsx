...
} from "../../../../../../identity/components/InviteDeliveryFields.js";
...
import type { App } from "../../../../../../identity/services/auth/api.js";

const getDefaultLocale = (supportedLocales: string[], defaultLocale?: string) => {
...
const ResendInviteModal = ({
	...
	const [locale, setLocale] = useState(getDefaultLocale(supportedLocales, defaultLocale));
	...
	return (
		<AlertDialog open={show}>
			<AlertDialogContent>
				...
				<VisuallyHidden>
					<AlertDialogDescription>{t("users.inviteRedirectDesc")}</AlertDialogDescription>
				</VisuallyHidden>
				...
				<AlertDialogFooter>
					...
					<Button data-testid="confirmResendInvite" onClick={handleConfirm} disabled={isLoading}>
