...
export default centralTests(
	...
	defineConfig({
		...
		test: {
			include: [
				"../../../../tests/checks/plugins/superboard-acquisition/onboardings/runtime/**/*.test.ts",
			],
			setupFiles: [
				"../../../../tests/checks/plugins/superboard-acquisition/onboardings/runtime/apply-migrations.ts",
			],
