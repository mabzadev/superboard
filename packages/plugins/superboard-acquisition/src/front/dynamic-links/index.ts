...
export const views = {
	...
	"superboard.acquisition_dynamic_links": () => import("./views/superboard.dynamic_links_links.js"),
	"superboard.acquisition_dynamic_links_campaigns": () =>
		import("./views/superboard.dynamic_links_campaigns.js"),
	"superboard.acquisition_dynamic_links_redirect_rules": () =>
		import("./views/superboard.dynamic_links_redirect_rules.js"),
	"superboard.acquisition_dynamic_links_domain": () =>
		import("./views/superboard.dynamic_links_domain.js"),
	"superboard.acquisition_dynamic_links_social_media_preview": () =>
		import("./views/superboard.dynamic_links_social_media_preview.js"),
	"superboard.acquisition_dynamic_links_tracking": () =>
		import("./views/superboard.dynamic_links_tracking.js"),
	"superboard.acquisition_dynamic_links_campaigns_by_id": () =>
		import("./views/superboard.dynamic_links_campaigns_by_id.js"),
};
