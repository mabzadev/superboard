...
import type { DynamicLink } from "../../../api/dynamic-links/dynamicLinksService.js";
...
export function toLinkData(link: DynamicLink): LinkData {
	...
	return {
		...
		path: link.slug,
		active: link.active,
		ads_platform: typeof link.utm.source === "string" ? link.utm.source : "quick-link",
		tags,
		...
		tracking_source: typeof link.utm.source === "string" ? link.utm.source : undefined,
		tracking_medium: typeof link.utm.medium === "string" ? link.utm.medium : undefined,
		tracking_campaign: typeof link.utm.campaign === "string" ? link.utm.campaign : undefined,
		...
		total_reactivations: numberFrom(values, "total_reactivations", "reactivations"),
		total_app_opens: numberFrom(values, "total_app_opens", "app_opens"),
		total_user_referred: numberFrom(values, "total_user_referred", "users_referred"),
