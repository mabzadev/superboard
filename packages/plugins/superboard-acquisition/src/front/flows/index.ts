...
export const views = {
	"superboard.acquisition_settings": () => import("./views/superboard.acquisition_settings.js"),
	...
	"superboard.acquisition_workflows": () => import("./views/superboard.flows_workflows.js"),
	"superboard.acquisition_launchpad": () => import("./views/superboard.flows_launchpad.js"),
	"superboard.acquisition_components": () => import("./views/superboard.flows_components.js"),
	"superboard.acquisition_users": () => import("./views/superboard.flows_users.js"),
	"superboard.acquisition_settings_environments": () =>
		import("./views/superboard.flows_settings_environments.js"),
	"superboard.acquisition_workflows_by_id": () =>
		import("./views/superboard.flows_workflows_by_id.js"),
	"superboard.acquisition_users_by_id": () => import("./views/superboard.flows_users_by_id.js"),
	"superboard.acquisition_settings_localization": () =>
		import("./views/superboard.flows_settings_localization.js"),
	"superboard.acquisition_settings_sdk": () => import("./views/superboard.flows_settings_sdk.js"),
};
