...
import { EXISTING_USERS_FILTER } from "../../../../../../../supbrd-front-ui/src/shared/constants/OptionsConstants.js";
		...
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent showCloseButton={false} className="sm:max-w-[480px]">
				<DialogHeader>
					...
					<DialogDescription>Please review the following before publishing.</DialogDescription>
				</DialogHeader>
					...
					<div className="flex items-start gap-3 rounded-lg border border-sidebar-border bg-secondary p-3">
						...
						<div className="flex flex-col gap-0.5">
							<span className="text-sm font-medium">
								{deliverTo === EXISTING_USERS_FILTER ? "Existing Users" : "New Users"}
							</span>
					...
					{deliverPushNotification && deliverTo === EXISTING_USERS_FILTER && (
						<div className="flex items-start gap-3 rounded-lg border border-amber-300/50 bg-amber-50 dark:bg-amber-950/20 p-3">
							...
							<div className="flex flex-col gap-0.5">
								...
								<span className="text-xs text-muted-foreground">
									Users with push notifications integrated will receive an alert with the title
									&quot;{title}&quot; and subtitle &quot;
									{subtitle}&quot;.
								</span>
							</div>
					...
					{autoDisplay && (
						<div className="flex items-start gap-3 rounded-lg border border-amber-300/50 bg-amber-50 dark:bg-amber-950/20 p-3">
							...
							<div className="flex flex-col gap-0.5">
								...
								<span className="text-xs text-muted-foreground">
									This message will automatically display as a full-screen overlay when users open
									the app.
								</span>
							</div>
						</div>
