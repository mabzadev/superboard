						...
						<PopoverTrigger asChild disabled={readOnly}>
							...
							>
								...
								<div className="flex flex-col min-w-0">
									...
									<span className="text-sm font-medium truncate">{selectedAudience.label}</span>
								</div>
					...
					<Popover open={autoDisplayOpen} onOpenChange={setAutoDisplayOpen}>
						<PopoverTrigger asChild disabled={readOnly}>
							...
							>
								...
								<div className="flex flex-col min-w-0">
									<span className="text-xs text-muted-foreground">Auto Display</span>
									<span className="text-sm font-medium truncate">
						...
						<PopoverContent align="start" className="w-[var(--radix-popover-trigger-width)] p-1">
							...
							>
								...
								{autoDisplay && <Check className="ml-auto h-4 w-4 shrink-0 text-primary" />}
							</button>
							<button
								onClick={() => {
