CREATE TABLE IF NOT EXISTS marketing_dead_letters (
  id TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS marketing_dead_letters_status_received
  ON marketing_dead_letters(status, received_at DESC);
