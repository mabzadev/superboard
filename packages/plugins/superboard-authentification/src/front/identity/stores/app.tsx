...
import type { CreatedAppDetail } from "../services/auth/api.js";
...
export const appSlice = createSlice({
	...
	initialState,
	reducers: {
		storeAcquireAuthToken: (state, action: PayloadAction<AppState["acquireAuthToken"]>) => {
			state.acquireAuthToken = action.payload;
		},
		storeCreatedApp: (state, action: PayloadAction<CreatedAppDetail | null>) => {
