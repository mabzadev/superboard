...
import type { Visitor, AggregatedVisitor, GetVisitorsParams } from "@superboard/front-ui/types";
...
export function useVisitorsQuery(projectId: string | undefined, params: GetVisitorsParams | null) {
...
export function useAggregatedVisitorsQuery(
	...
	return useQuery<AggregatedVisitorsResult>({
		queryKey: queryKeys.projects.aggregatedVisitors(projectId!, params ?? undefined),
		queryFn: async () => {
