...
export const views = {
	"superboard.identity_by_lang_settings": () =>
		import("./views/superboard.identity_by_lang_settings.js"),
	...
	"superboard.auth_users": () => import("./views/superboard.users.js"),
	"superboard.auth_apps": () => import("./views/superboard.identity_by_lang_apps.js"),
	"superboard.auth_settings": () => import("./views/superboard.identity_by_lang_settings.js"),
	"superboard.auth_logs": () => import("./views/superboard.identity_by_lang_logs.js"),
	"superboard.app_users": () => import("./views/superboard.users.js"),
};
