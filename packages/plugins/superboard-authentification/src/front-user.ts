import type { NativeRendererMountInput } from "../../../supbrd-core/src/native-front.js";
import {
...
const contribution = defineNativeFrontPlugin({
	...
	surfaces: [
		...
		{
			path_pattern: "/identity/:lang/settings",
			title: "Authentication settings",
			navigation: identity("Settings", 10, "/identity/en/settings"),
		},
		{
		...
		{
			path_pattern: "/auth/settings",
			title: "Authentication settings",
			navigation: identity("Settings", 10, "/auth/settings?lang=en"),
		},
		{
			path_pattern: "/auth/apps",
			title: "Identity · Applications",
			navigation: identity("Applications", 4, "/auth/apps?lang=en"),
		},
		{
			path_pattern: "/auth/logs",
			title: "Identity · Logs",
			navigation: identity("Logs", 7, "/auth/logs?lang=en"),
		},
	],
});
