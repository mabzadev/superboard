...
import { isSafePublicHttpsUrl } from "../../../../../../supbrd-front-ui/src/shared/lib/validation.js";
import {
						...
						<CardContent className="space-y-4">
							...
							<div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
								<div className="space-y-2">
									<Label htmlFor="support-integration-provider">Integration</Label>
									<select
								...
								<div className="space-y-2">
									...
									{provider === "webhook" && target && !targetIsValid ? (
										<p className="text-xs text-destructive" role="alert">
											Use a public HTTPS URL without credentials, fragments, or private-network
											addresses.
										</p>
									) : null}
								</div>
							...
							{needsCredentialAccess && canManageCredentials ? (
								<div className="space-y-3 rounded-lg border p-4">
									<div>
										...
										<p className="mt-1 text-xs text-muted-foreground">
											Values are sent only to the write-only credential endpoint, encrypted per
											project, and cleared from this form after every submission attempt.
										</p>
									</div>
									<div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
								...
								<AccessNotice>
									Only project owners and administrators can create or replace integration
									credentials. Existing secrets are never loaded into this page.
								</AccessNotice>
							) : null}
										...
										<CardContent className="flex flex-wrap items-center justify-between gap-3 p-4">
											<div>
												...
												{item.status === "configuration_required" ? (
													<p className="mt-1 text-xs text-muted-foreground">
														Save all required credentials before this integration can process
														Support events.
													</p>
												) : null}
											</div>
