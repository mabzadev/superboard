...
export const getSupportCsat = async (projectId: string): Promise<{ data: SupportCsat[] }> =>
	(await GET(path(projectId, "/csat"))).data;
export const getSupportQuality = async (projectId: string): Promise<{ data: SupportQuality }> =>
	(await GET(path(projectId, "/quality"))).data;
export const getSupportAudit = async (projectId: string): Promise<{ data: SupportAuditEvent[] }> =>
