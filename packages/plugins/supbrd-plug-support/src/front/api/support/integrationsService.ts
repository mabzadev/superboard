import type { SupportProviderStatus } from "./channelsService.js";
import {
...
export const listSupportIntegrations = (projectRef: string, query?: SupportCursorQuery) =>
...
) => createSupportResource<SupportIntegration, typeof input>(projectRef, "integrations", input);
export const updateSupportIntegration = (
	projectRef: string,
	id: string,
	input: Partial<Pick<SupportIntegration, "display_name" | "status" | "settings">>,
) => updateSupportResource<SupportIntegration, typeof input>(projectRef, "integrations", id, input);
