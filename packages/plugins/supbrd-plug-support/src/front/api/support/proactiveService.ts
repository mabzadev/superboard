...
export const listSupportCampaigns = (projectRef: string, query?: SupportCursorQuery) =>
	listSupportResource<SupportCampaign>(projectRef, "proactive-support/campaigns", query);

export const createSupportCampaign = (
	projectRef: string,
	input: Pick<
		SupportCampaign,
		"inbox_id" | "name" | "campaign_type" | "message" | "audience" | "scheduled_at"
	>,
) =>
