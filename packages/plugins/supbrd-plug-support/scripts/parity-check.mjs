...
const audit = resolve(root, "packages/plugins/supbrd-plug-support/scripts/support-audit");
...
const testRunners = Object.freeze({
	"vitest-support": {
		prefix: "tests/checks/plugins/supbrd-plug-support/worker/unit/",
		file: /\.test\.ts$/u,
	},
	"vitest-workers": {
		prefix: "tests/checks/plugins/supbrd-plug-support/worker/runtime/",
		file: /\.test\.ts$/u,
	},
	"vitest-api": {
		prefix: "tests/checks/plugins/supbrd-core/api/unit/",
		file: /\.test\.ts$/u,
	},
	"vitest-plugin-front": {
