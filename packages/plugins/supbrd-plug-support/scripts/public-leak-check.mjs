...
const sources = [
	...
	"packages/plugins/supbrd-core/src/front",
	"packages/plugins/supbrd-plug-identity/src/front",
	"packages/plugins/supbrd-plug-data/src/front",
	"packages/plugins/supbrd-plug-commerce/src/front",
	"packages/plugins/supbrd-plug-communication/src/front",
	"packages/plugins/supbrd-plug-journeys/src/front",
	"packages/plugins/supbrd-plug-support/src/front",
	"packages/plugins/supbrd-plug-analytics/src/front",
	...
	"packages/plugins/supbrd-plug-support/worker/src",
	"packages/plugins/supbrd-plug-communication/email/src",
...
const artifactSources = [
	...
	"packages/plugins/supbrd-core/dist",
	"packages/plugins/supbrd-plug-identity/dist",
	"packages/plugins/supbrd-plug-data/dist",
	"packages/plugins/supbrd-plug-commerce/dist",
	"packages/plugins/supbrd-plug-communication/dist",
	"packages/plugins/supbrd-plug-journeys/dist",
	"packages/plugins/supbrd-plug-support/dist",
	"packages/plugins/supbrd-plug-analytics/dist",
];
const failures = [];
...
function isPublishedSupportSurface(file) {
	return (
		file.startsWith("packages/plugins/supbrd-plug-support/worker/src/") ||
		/^workers\/api\/src\/lib\/support-gateway(?:\.|\/)/u.test(file) ||
		file.startsWith("packages/plugins/supbrd-plug-support/src/front/") ||
