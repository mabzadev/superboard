-- SuperBoard identity cutover. A high-entropy secret is written separately by
...
SET name = 'SuperBoard Dashboard Vocostar', updated_at = datetime('now')
