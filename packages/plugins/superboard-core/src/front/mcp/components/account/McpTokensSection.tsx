...
import { useMcpTokensQuery, useRevokeMcpTokenMutation } from "../../hooks/queries/useMcpQueries.js";
				...
				<div className="rounded-xl border border-sidebar-border px-5 py-8 flex flex-col items-center gap-4">
					...
					<div className="flex flex-col items-center gap-1 text-center">
						...
						<span className="text-xs text-muted-foreground leading-relaxed">
							Connect AI tools like Claude Desktop or Cursor to manage your links and analytics
							directly from your editor.
						</span>
					</div>
					{config.docsUrl && (
						<a href={`${config.docsUrl}/mcp`} target="_blank" rel="noopener noreferrer">
