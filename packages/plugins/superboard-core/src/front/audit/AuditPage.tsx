			...
			<FrontTable>
				<FrontTableHeader>
					<FrontTableRow>
						...
						<FrontTableHead>{t.operation}</FrontTableHead>
						<FrontTableHead>{t.action}</FrontTableHead>
						<FrontTableHead>{t.status}</FrontTableHead>
					</FrontTableRow>
				</FrontTableHeader>
				<FrontTableBody>
					{entries.map((entry) => (
						<FrontTableRow key={entry.sequence}>
							<FrontTableCell>{entry.sequence}</FrontTableCell>
							<FrontTableCell>{entry.operation_id}</FrontTableCell>
							<FrontTableCell>{entry.payload.action}</FrontTableCell>
							<FrontTableCell>{entry.payload.status}</FrontTableCell>
						</FrontTableRow>
					))}
				</FrontTableBody>
			</FrontTable>
