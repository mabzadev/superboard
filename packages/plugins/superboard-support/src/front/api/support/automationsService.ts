...
const crud = <T>(resource: string) => ({
	...
	remove: (projectRef: string, id: string) => deleteSupportResource(projectRef, resource, id),
});

export const supportAutomations = crud<SupportAutomation>("automations");
export const supportAssignmentPolicies = crud<SupportAssignmentPolicy>("assignment-policies");
export const supportWorkingHours = crud<SupportWorkingHours>("sla/working-hours");
export const supportSlaPolicies = crud<SupportSlaPolicy>("sla/policies");
export const supportMacros = crud<SupportMacro>("macros");
export const supportCannedResponses = crud<SupportCannedResponse>("canned-responses");
