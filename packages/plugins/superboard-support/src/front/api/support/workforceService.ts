...
export const listSupportMemberships = (projectRef: string, query?: SupportCursorQuery) =>
	listSupportResource<SupportMembership>(projectRef, "workforce/memberships", query);
...
export const listSupportTeams = (projectRef: string, query?: SupportCursorQuery) =>
	listSupportResource<SupportTeam>(projectRef, "workforce/teams", query);

export const createSupportTeam = (
	projectRef: string,
	input: Pick<SupportTeam, "name" | "description" | "allow_auto_assign" | "active">,
) => createSupportResource<SupportTeam, typeof input>(projectRef, "workforce/teams", input);

export const updateSupportTeam = (
	projectRef: string,
	id: string,
	input: Partial<Pick<SupportTeam, "name" | "description" | "allow_auto_assign" | "active">>,
) => updateSupportResource<SupportTeam, typeof input>(projectRef, "workforce/teams", id, input);

export const deleteSupportTeam = (projectRef: string, id: string) =>
	deleteSupportResource(projectRef, "workforce/teams", id);

export const listSupportInboxes = (projectRef: string, query?: SupportCursorQuery) =>
...
) => createSupportResource<SupportInbox, typeof input>(projectRef, "workforce/inboxes", input);

export const updateSupportInbox = (
	projectRef: string,
	id: string,
	input: Partial<Omit<SupportInbox, keyof SupportEntity | "identifier" | "channel_type">>,
) => updateSupportResource<SupportInbox, typeof input>(projectRef, "workforce/inboxes", id, input);

export const deleteSupportInbox = (projectRef: string, id: string) =>
	deleteSupportResource(projectRef, "workforce/inboxes", id);

export const listSupportCapacityPolicies = (projectRef: string, query?: SupportCursorQuery) =>
	listSupportResource<SupportCapacityPolicy>(projectRef, "workforce/capacity-policies", query);
...
export const listSupportLeaves = (projectRef: string, query?: SupportCursorQuery) =>
	listSupportResource<SupportLeave>(projectRef, "workforce/leave-schedules", query);

export const createSupportLeave = (
	projectRef: string,
	input: Omit<SupportLeave, keyof SupportEntity>,
) =>
	createSupportResource<SupportLeave, typeof input>(projectRef, "workforce/leave-schedules", input);
...
export const linkSupportTeamMember = (projectRef: string, teamId: string, membershipId: string) =>
	putSupportAction(
		projectRef,
...
export const unlinkSupportTeamMember = (projectRef: string, teamId: string, membershipId: string) =>
	deleteSupportAction(
		projectRef,
		`workforce/teams/${encodeURIComponent(teamId)}/members/${encodeURIComponent(membershipId)}`,
	);

export const listSupportInboxMembers = (projectRef: string, inboxId: string) =>
	getSupportAction<SupportMembership[]>(
		projectRef,
		`workforce/inboxes/${encodeURIComponent(inboxId)}/members`,
	);

export const linkSupportInboxMember = (projectRef: string, inboxId: string, membershipId: string) =>
	putSupportAction(
		projectRef,
