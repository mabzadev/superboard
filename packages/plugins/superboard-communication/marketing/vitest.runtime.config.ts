...
export default centralTests(
	...
	defineConfig({
		...
		test: {
			include: [
				"../../../../tests/checks/plugins/superboard-communication/marketing/runtime/**/*.test.ts",
			],
			setupFiles: [
				"../../../../tests/checks/plugins/superboard-communication/marketing/runtime/apply-migrations.ts",
			],
		},
	}),
);
