	...
	return (
		<div className="space-y-4 rounded-xl border bg-muted/20 p-4">
			...
			<div className="grid min-h-[420px] gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
				<div className="h-[620px] overflow-hidden rounded-lg border border-kumo-line bg-kumo-tint">
					<ReactFlow
...
function JourneyGraphNode({ data }: NodeProps) {
	return (
		<div className="w-60 rounded-lg border border-kumo-line bg-kumo-base p-4 text-kumo-default shadow-sm">
