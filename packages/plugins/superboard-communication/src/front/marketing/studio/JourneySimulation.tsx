...
import type { EmailTemplate, JourneyDefinition } from "../api/marketing/marketingService.js";
...
export function JourneySimulation({
	...
	return (
		<details className="rounded-lg border border-kumo-line bg-kumo-base p-4">
