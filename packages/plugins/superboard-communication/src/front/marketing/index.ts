...
export const views = {
	...
	"superboard.communication_campaigns": () => import("./views/superboard.marketing_campaigns.js"),
	"superboard.communication_in_app_messages": () =>
		import("./views/superboard.marketing_in_app_messages.js"),
	"superboard.communication_marketing_email": () => import("./views/superboard.marketing_email.js"),
	"superboard.communication_notifications": () => import("./PushNotificationsPage.js"),
	"superboard.communication_channels": () => import("./views/superboard.marketing_channels.js"),
	"superboard.communication_statistics": () => import("./views/superboard.marketing_statistics.js"),
	"superboard.communication_settings": () => import("./views/superboard.marketing_settings.js"),
	"superboard.communication_journeys": () => import("./views/superboard.marketing_journeys.js"),
};
