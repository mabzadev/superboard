import type { ApiWorkerGeneratedEnv } from "./generated-env.js";
...
export interface BillingEnv {
	...
	SUPERBOARD_ENTITLEMENT_WEBHOOK_SECRET?: string;
...
interface ApiSecretEnv {
	...
	EMAIL?: SendEmail;
	SUPERBOARD_CUTOVER_TOKEN?: string;
	JWT_SECRET: string;
...
export interface AppVariables {
	operatorId?: string;
	internalProject?: import("@superboard/contracts/project-context").InternalProjectContext;
	siteOperator?: import("@superboard/contracts/site-operator").SiteOperatorIdentity;
	userId: number;
	instanceId: number;
	projectId?: number;
