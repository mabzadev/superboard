...
} from "../mutations/useConfigurationMutations.js";
import { createTestQueryClient } from "./query-test-utils.js";

vi.mock(
	"../../../../supbrd-plugmod-analytics/source/api/configurations/redirect/configRedirectService.js",
	() => ({
...
vi.mock(
	"../../../../supbrd-plugmod-analytics/source/api/configurations/domains/configDomainsService.js",
	() => ({
...
vi.mock("../../../../supbrd-plug-settings/source/analytics/index.js", () => ({
	trackEvent: vi.fn(),
	EVENTS: {
...
import type { GoogleTrackingIdPayload } from "../../../../../../../../../supbrd-front-ui/src/shared/types/index.js";
import { trackEvent } from "../../../../supbrd-plug-settings/source/analytics/index.js";
import {
	setSubdomainAPICall,
	setGoogleTrackingIDAPICall,
	verifySubdomainAvailabilityAPICall,
} from "../../../../supbrd-plugmod-analytics/source/api/configurations/domains/configDomainsService.js";
import {
	setDefaultRedirectAPICall,
	setRedirectAPICall,
} from "../../../../supbrd-plugmod-analytics/source/api/configurations/redirect/configRedirectService.js";
