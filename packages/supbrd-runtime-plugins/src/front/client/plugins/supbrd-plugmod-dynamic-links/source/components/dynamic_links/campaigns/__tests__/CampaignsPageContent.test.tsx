...
vi.mock(
	"../../../../../../../../../../../supbrd-front-ui/src/shared/hooks/useTableParams.js",
	() => ({
		useTableParams: () => ({
			page: 1,
...
vi.mock("../CampaignAnalyticsTable.js", () => ({
...
import CampaignsPageContent from "../CampaignsPageContent.js";
