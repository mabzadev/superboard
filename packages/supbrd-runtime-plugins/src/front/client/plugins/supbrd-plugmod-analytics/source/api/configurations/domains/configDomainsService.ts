...
export const verifySubdomainAvailabilityAPICall = async (
	...
	return POST(config.apiPath + `/projects/${projectId}/domain/check_availability`, data);
};
...
export const setGoogleTrackingIDAPICall = async (
	...
	return PUT(config.apiPath + `/projects/${projectId}/domain/google_tracking_id`, formData);
};
