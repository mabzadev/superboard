...
vi.mock("../../../api/app/appService.js", () => ({
	getAppOverview: mocks.appOverview,
	getAccessKey: mocks.accessKey,
}));

vi.mock("../../../api/dynamic-links/dynamicLinksService.js", () => ({
...
vi.mock(
	"../../../../../../../../../../supbrd-front-ui/src/shared/components/modules/ModulePage.js",
	() => ({
...
vi.mock(
	"../../../../../../../../../../supbrd-front-ui/src/shared/components/dateRangePicker/DateRangePicker.js",
	() => ({
...
vi.mock("../../layout/section-cards.js", () => ({
...
vi.mock("../../analytics/AnalyticsPages.js", () => ({
