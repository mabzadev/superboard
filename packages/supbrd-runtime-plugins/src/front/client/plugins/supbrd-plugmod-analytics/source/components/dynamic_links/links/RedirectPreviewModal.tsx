...
} from "../../../hooks/useResolvedRedirects.js";
			...
			<DialogContent className="sm:max-w-[90vw] xl:max-w-[1400px] max-h-[90vh] p-0 gap-0 overflow-hidden border-sidebar-border flex flex-col">
				...
				<DialogHeader className="px-6 pt-5 pb-4 shrink-0">
					<div className="flex items-center justify-between pr-8">
						<div>
							<DialogTitle className="text-base font-semibold">Redirect Preview</DialogTitle>
				...
				<div className="overflow-auto px-6 pb-6" ref={treeRef}>
					...
					<div className="flex flex-col items-center pt-5 pb-3">
						...
						{linkUrl && (
							<span className="text-[10px] font-mono text-muted-foreground mt-1.5">{linkUrl}</span>
						)}
					</div>
	...
	return (
		<div
			className={cn(
				...
				copied ? "border-valid-green/30 bg-valid-green-light/10" : "border-primary/20 bg-primary/5",
			)}
		>
			{label && (
...
const SourceBadge = ({ source }: { source: "custom" | "default" }) => (
	<Badge variant={source === "custom" ? "default" : "outline"} className="text-[10px] py-0 px-1.5">
...
const PlatformBranch = ({
	...
	return (
		<div className="flex flex-col items-center group/platform hover:bg-muted/30 rounded-xl pt-0 pb-3 px-2 transition-colors">
			...
			{redirect.type === "redirect_web" && <RedirectWebBranch redirect={redirect} />}
...
const RedirectWebBranch = ({ redirect }: { redirect: ResolvedPlatformRedirect }) => (
	...
	<div className="flex flex-col items-center w-full">
		...
		<div className="flex w-full mt-1">
			...
			<div className="w-1/2 flex flex-col items-center px-0.5 overflow-hidden">
				<VLine className="h-3" />
				<span className="text-[10px] font-semibold text-valid-green mb-1">Yes</span>
			...
			<div className="w-1/2 flex flex-col items-center px-0.5 overflow-hidden">
				<VLine className="h-3" />
				<span className="text-[10px] font-semibold text-muted-foreground mb-1">No</span>
