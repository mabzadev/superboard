...
vi.mock("../../../api/analytics/analyticsService.js", () => ({
	...
	getAnalyticsSettings: vi
		.fn()
		.mockResolvedValue({ data_collection_enabled: true, hot_retention_days: 30, timezone: "UTC" }),
...
import { AnalyticsPage, type AnalyticsPageKind } from "../AnalyticsPages.js";
