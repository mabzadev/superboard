...
export const supportCategories = resource<SupportCategory>("help-center/categories");
...
export const supportTranslations = resource<Record<string, unknown> & SupportEntity>(
