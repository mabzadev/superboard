...
vi.mock("../../../api/support/settingsService.js", () => ({
...
vi.mock("../../../api/support/operationsHealthService.js", () => ({
...
vi.mock("../../../api/support/channelsService.js", () => ({
...
vi.mock("../../../api/support/workforceService.js", () => ({
	listSupportInboxes: services.listInboxes,
}));
vi.mock("../../../api/support/operationsService.js", () => ({
...
import SupportSettingsPage from "../SupportSettingsPage.js";
