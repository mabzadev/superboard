			...
			{!selectedProject ? (
				...
				<div className="space-y-6">
					...
					<div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
						...
						/>
						<Metric label="CSAT responses" value={String(quality?.csat.responses ?? 0)} />
						<Metric label="Open conversations" value={String(quality?.conversations.open ?? 0)} />
						<Metric
							label="First reply"
					...
					<div className="grid gap-6 xl:grid-cols-2">
						<Card>
							<CardHeader>
								...
								<CardDescription>Latest ratings and customer feedback</CardDescription>
							</CardHeader>
