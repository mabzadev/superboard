...
const resource = <T>(path: string) => ({
	...
	remove: (projectRef: string, id: string) => deleteSupportResource(projectRef, path, id),
});

export const supportAssistants = resource<SupportAssistant>("captain/assistants");
export const supportAssistantScenarios = resource<SupportAssistantScenario>("captain/scenarios");
export const supportAssistantTools = resource<SupportAssistantTool>("captain/tools");
export const listSupportAssistantTasks = (projectRef: string, query?: SupportCursorQuery) =>
