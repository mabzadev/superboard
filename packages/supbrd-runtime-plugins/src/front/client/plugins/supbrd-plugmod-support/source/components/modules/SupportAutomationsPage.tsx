...
export default function SupportAutomationsPage() {
	...
	const assignments = useSupportCollection(projectRef, supportAssignmentPolicies.list);
	...
	const cannedResponses = useSupportCollection(projectRef, supportCannedResponses.list);
			...
			{!selectedProject ? (
				...
				<Tabs defaultValue="rules">
					...
					<TabsContent className="space-y-4" value="assignment">
						...
						<Card>
							<CardHeader>
								<CardTitle className="text-base">New assignment policy</CardTitle>
							</CardHeader>
							<CardContent className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
								<Field label="Name">
									<Input
