...
vi.mock("../../../../../../../../../supbrd-front-ui/src/shared/lib/config.js", () => ({
	...
	usePublicConfig: () => ({ docsUrl: "https://docs.example.com", mcpUrl: "https://mcp.example.com" }),
}));

vi.mock("../../hooks/queries/useMcpQueries.js", () => ({
...
import McpTokensSection from "../account/McpTokensSection.js";
