...
export const listMcpTokensAPICall = async (): Promise<AxiosResponse<McpTokensResponse>> => {
	return GET(config.apiPath + "/mcp/tokens");
};

export const revokeMcpTokenAPICall = async (tokenId: string): Promise<AxiosResponse> => {
