...
vi.mock("../../../api/platform/platformService.js", () => ({
...
import LibrariesPageContent from "../LibrariesPageContent.js";
...
describe("LibrariesPageContent", () => {
	...
	it("does not present public package metadata as anonymous installation", async () => {
		...
		expect(screen.getByText("OPENGROW_GITHUB_PACKAGES_TOKEN")).toBeInTheDocument();
	...
	it("shows the staged SuperBoard coordinate without replacing the release baseline", async () => {
		...
		expect(screen.getAllByText("sdk-flutterflow-v2.2.5")).not.toHaveLength(0);
	});
