		...
		<div className="flex flex-col gap-5">
			<div className="flex flex-col gap-2">
				...
				<span className="text-xs text-muted-foreground">
					This will be used as a title of the push notification, and will be shown in the messages
					list.
				</span>
			</div>
			...
			<div className="flex flex-col gap-2">
				...
				<span className="text-xs text-muted-foreground">
					This will be used as a subtitle of the push notification, and will be shown in the
					messages list.
				</span>
			</div>
		</div>
