...
import { getAccessKey, rotateAccessKey, type AccessKeyInfo } from "../../api/app/appService.js";
import { RenderCodeBlock } from "../developers/SetupShared.js";
				...
				<div className="grid gap-6 xl:grid-cols-[1fr_420px]">
						...
						<Card>
							<CardHeader className="flex-row items-start gap-3">
								...
								<div className="flex-1">
									...
									<CardDescription>Scoped to the selected project and environment.</CardDescription>
								</div>
							...
							<CardContent className="space-y-5">
								<div className="flex items-center gap-2 rounded-lg border bg-muted/30 p-4">
									<code className="min-w-0 flex-1 break-all text-sm">{displayedKey}</code>
									<Button
										variant="outline"
										size="icon"
								...
								{secret ? (
									<Alert variant="destructive">
										...
										<AlertDescription>
											Store this value in your app configuration now. Refreshing this page
								...
								<div className="flex flex-wrap gap-2">
									<Button disabled={loading} onClick={() => setRotateOpen(true)}>
					...
					<Card className="h-fit">
						<CardHeader>
							...
							<CardDescription>
								Use the full key only in client SDK initialization, never in the Dashboard API.
							</CardDescription>
						</CardHeader>
						<CardContent>
							<RenderCodeBlock
