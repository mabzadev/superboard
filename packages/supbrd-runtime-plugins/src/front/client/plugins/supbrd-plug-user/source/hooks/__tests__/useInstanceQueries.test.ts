...
} from "../../../../supbrd-plug-settings/source/hooks/queries/useInstanceQueries.js";
import { createTestQueryClient } from "../../../../supbrd-plugmod-dynamic-links/source/hooks/__tests__/query-test-utils.js";

vi.mock("../../../../supbrd-plug-settings/source/api/instances/instanceService.js", () => ({
...
vi.mock(
	"../../../../supbrd-plug-settings/source/api/applications/configApplicationsService.js",
	() => ({
...
import { getProjectConfigurationAPICall } from "../../../../supbrd-plug-settings/source/api/applications/configApplicationsService.js";
import {
	getInstancesAPICall,
...
} from "../../../../supbrd-plug-settings/source/api/instances/instanceService.js";
