...
import { Activity, AlertTriangle, ClipboardList, Network, RefreshCw, Users } from "lucide-react";
...
import { flowsApi, type FlowOverview } from "../../api/flows/flowsService.js";
		...
		() =>
			overview
				? ([
						...
						[t("surveyMetric"), overview.counters.survey_responses, ClipboardList],
						[t("incidentsMetric"), overview.counters.dead_letters, AlertTriangle],
					] as const)
				: [],
		[overview, t],
	);
								...
								<Table>
									<TableHeader>
										<TableRow>
											...
											<TableHead className="pr-4 text-right">{tr("Time")}</TableHead>
										</TableRow>
									</TableHeader>
									<TableBody>
