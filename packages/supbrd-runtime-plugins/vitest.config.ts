...
const shared = fileURLToPath(new URL("../supbrd-front-ui/src/", import.meta.url));
export default defineConfig({
	...
	test: {
		coverage: {
			provider: "v8",
			include: ["src/front/client/plugins/*/source/hooks/**"],
			exclude: [
				"**/__tests__/**",
				"**/lib/api.ts",
		...
		setupFiles: [fileURLToPath(new URL("../supbrd-front-ui/tests/setup.ts", import.meta.url))],
