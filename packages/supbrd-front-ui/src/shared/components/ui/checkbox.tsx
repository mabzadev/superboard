...
type CheckboxRoundProps = React.ComponentProps<typeof CheckboxPrimitive.Root> & {
	variant?: "default" | "green";
};

function Checkbox({ className, variant = "default", ...props }: CheckboxRoundProps) {
	return (
		<CheckboxPrimitive.Root
			...
			className={cn(
				...
				variant === "green" &&
					"data-[state=checked]:bg-valid-green-light data-[state=checked]:text-valid-green data-[state=checked]:border-none",
				className,
			)}
			{...props}
		>
