 ...
 */
export const hasText = (v: unknown): v is string => typeof v === "string" && v.trim() !== "";

/**
 * Checks if a URL is a valid HTTPS URL.
 */
export const isValidHttpsUrl = (url: string | undefined | null): url is string =>
	!!url && isURL(url) && url.startsWith("https://");
