...
export const queryKeys = {
	projects: {
		...
		campaignMetrics: (projectId: string, params?: DateRangeQuery) =>
			[...queryKeys.projects.detail(projectId), "campaignMetrics", params] as const,
		...
		metricsOverview: (projectId: string, params?: DateRangeQuery) =>
			[...queryKeys.projects.detail(projectId), "metricsOverview", params] as const,
		...
		revenueMetrics: (projectId: string, params?: GetRevenueParams) =>
			[...queryKeys.projects.detail(projectId), "revenueMetrics", params] as const,
		notifications: (projectId: string, params?: GetMessagingParams) =>
			[...queryKeys.projects.detail(projectId), "notifications", params] as const,
		...
		eventsSorted: (projectId: string, params?: EventsSortedPayload) =>
			[...queryKeys.projects.detail(projectId), "eventsSorted", params] as const,
		eventsOverview: (projectId: string, params?: DateRangeQuery) =>
			[...queryKeys.projects.detail(projectId), "eventsOverview", params] as const,
		eventsPayment: (projectId: string, params?: DateRangeQuery) =>
			[...queryKeys.projects.detail(projectId), "eventsPayment", params] as const,
		...
		aggregatedVisitors: (projectId: string, params?: GetVisitorsParams) =>
			[...queryKeys.projects.detail(projectId), "aggregatedVisitors", params] as const,
		visitorDetails: (projectId: string, visitorId: string) =>
			[...queryKeys.projects.detail(projectId), "visitorDetails", visitorId] as const,
	...
	instances: {
		...
		detail: (instanceId: string) => [...queryKeys.instances.all, instanceId] as const,
		members: (instanceId: string) =>
			[...queryKeys.instances.detail(instanceId), "members"] as const,
		config: (instanceId: string) => [...queryKeys.instances.detail(instanceId), "config"] as const,
		...
		setupProgress: (instanceId: string, category: string) =>
			[...queryKeys.instances.detail(instanceId), "setupProgress", category] as const,
	},
