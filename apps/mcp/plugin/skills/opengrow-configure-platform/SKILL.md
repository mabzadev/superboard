---
name: opengrow-configure-platform
...
# OpenGrow: Configure Platform Settings
...
Every OpenGrow tool returns human-readable formatted text. Don't reformat — just present and add context.
