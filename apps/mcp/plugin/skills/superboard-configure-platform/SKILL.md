---
name: superboard-configure-platform
...
# SuperBoard: Configure Platform Settings
...
Every SuperBoard tool returns human-readable formatted text. Don't reformat — just present and add context.
