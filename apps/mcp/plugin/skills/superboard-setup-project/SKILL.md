---
name: superboard-setup-project
description: Set up a new mobile app project in SuperBoard — create an instance, configure iOS Universal Links or Android App Links, and set redirect behavior so your tracking links work out of the box. Use when the user wants to create a new app, project, or start using SuperBoard.
---

# SuperBoard: Set Up a New Project
...
User: "Set up SuperBoard for my app Foodies, it's iOS only, bundle is com.foodies.app, team ID is ABC123"
...
It is not an SuperBoard edition, quota, capacity or subscription gate.
...
Every SuperBoard tool returns human-readable formatted text (tables, summaries). Don't reformat — just present the response and add your own context around it.
