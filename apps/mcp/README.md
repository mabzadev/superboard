<p align="center">
  <picture>
    ...
    <img src=".github/logo.svg" width="120" alt="OpenGrow">
  </picture>
</p>
...
<p align="center">
  MCP server for managing deep links, analytics, and app configuration on <a href="https://github.com/mbzadev/opengrow-platform">OpenGrow</a>.
  <br />
  Works with Claude Code, Cursor, Windsurf, and any MCP-compatible client.
</p>

<p align="center">
  <a href="https://github.com/mbzadev/opengrow-platform">Website</a> &middot;
  <a href="https://github.com/mbzadev/opengrow-platform/tree/main/docs">Documentation</a> &middot;
  <a href="https://github.com/mbzadev/opengrow-platform/issues">Issues</a>
</p>
...
[Worker source](https://github.com/mbzadev/opengrow-platform/tree/main/workers/api)
...
```
/plugin marketplace add ./opengrow-platform/apps/mcp
...
```bash
docker build -f apps/mcp/Dockerfile -t opengrow-mcp apps/mcp
...
| `OPENGROW_API_URL` | required | API origin from the selected OpenGrow target |
...
| Platform | Repository |
|----------|-----------|
| iOS | [`sdks/ios`](https://github.com/mbzadev/opengrow-platform/tree/main/sdks/ios) |
| Android | [`sdks/android`](https://github.com/mbzadev/opengrow-platform/tree/main/sdks/android) |
| React Native | [`sdks/react-native`](https://github.com/mbzadev/opengrow-platform/tree/main/sdks/react-native) |
| Flutter | [`sdks/flutter`](https://github.com/mbzadev/opengrow-platform/tree/main/sdks/flutter) |
