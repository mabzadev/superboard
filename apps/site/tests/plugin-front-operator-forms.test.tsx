...
import { OperatorProfile } from "../../../packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-user/OperatorProfile.js";
...
vi.mock(
	"../../../packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-user/transport.js",
	() => ({
