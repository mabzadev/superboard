...
import InstanceConfiguration from "../../../packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-settings/InstanceConfiguration.js";
...
test("the French settings view follows configuration returned by the running API", async () => {
	let configuration: DeploymentConfiguration = {
		...
		source: "deploy/targets/mbza-development.json",
		checksum: "first",
