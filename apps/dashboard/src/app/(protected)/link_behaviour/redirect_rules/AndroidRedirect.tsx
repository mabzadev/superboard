...
const AndroidRedirect = ({
  ...
  const androidApp = watch("android.enabled");
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <span className="text-xs text-muted-foreground leading-snug">
            Configure how links behave on Android devices.
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <OptionCard
            selected={androidApp === true}
            onClick={() => {
              setValue("android.enabled", true, { shouldDirty: true });
              setValue("android.appStore", true, { shouldDirty: true });
              setValue("android.showPreview", true, { shouldDirty: true });
              setTimeout(
                () =>
          ...
          />
          <OptionCard
            selected={androidApp === false}
            onClick={() => {
              setValue("android.enabled", false, { shouldDirty: true });
              setValue(
                "android.appStore",
                defaultValues?.android?.appStore ?? false,
                { shouldDirty: true }
              );
              setValue(
                "android.showPreview",
        ...
        <div ref={webUrlRef} className="flex flex-col gap-1.5">
          ...
          <div className="flex w-full relative">
            <Input
              ...
              value={customUrl}
              onChange={(e) =>
                setValue("android.customUrl", e.currentTarget.value, {
                  shouldDirty: true,
                })
              }
            />
      ...
      <div ref={appSectionRef} className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <OptionCard
            selected={androidShowPreview === true}
            onClick={() =>
              setValue("android.showPreview", true, { shouldDirty: true })
            }
            icon={Eye}
          ...
          />
          <OptionCard
            selected={androidShowPreview === false}
            onClick={() =>
              setValue("android.showPreview", false, { shouldDirty: true })
            }
            icon={EyeOff}
            title="Skip Preview"
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col gap-2 min-w-0 flex-1">
                  ...
                  <span className="text-xs text-amber-600/80 dark:text-amber-400/80 leading-relaxed">
                    Integrate the Android SDK to enable app redirects.
                    You&apos;ll need your package name and SHA256 fingerprint.
                  </span>
                  <Link
                    href="/developers/android_setup"
            ...
            <>
              ...
              <div className="rounded-lg border border-sidebar-border bg-muted/30 p-4">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <OptionCard
                      selected={androidStore === true}
                      onClick={() =>
                        setValue("android.appStore", true, {
                          shouldDirty: true,
                        })
                      }
                      icon={Store}
                    ...
                    />
                    <OptionCard
                      selected={androidStore === false}
                      onClick={() => {
                        setValue("android.appStore", false, {
                          shouldDirty: true,
                        });
                        setTimeout(
                          () =>
                    ...
                    >
                      ...
                      <div className="flex w-full relative">
                        <Input
                          ...
                          placeholder="https://example.com/download-android"
                          value={customUrl}
                          onChange={(e) =>
                            setValue(
                              "android.customUrl",
