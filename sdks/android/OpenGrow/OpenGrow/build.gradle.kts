...
private val libraryGroupId = "io.opengrow"
    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    name.set("OpenGrow")
                    description.set("OpenGrow is a powerful SDK that enables deep linking and universal linking within your mobile and web applications.")
                }
            }
        }
    }
