...
import io.opengrow.databinding.LayoutNotificationListItemBinding
import java.lang.IllegalStateException

sealed class NotificationsListItem {
    data class Notification(val item: io.opengrow.model.notifications.Notification) : NotificationsListItem()
}
