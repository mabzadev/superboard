...
import io.opengrow.databinding.FragmentAutoDisplayedNotificationBinding
import io.opengrow.model.notifications.Notification
import io.opengrow.service.OpenGrowService
import io.opengrow.utils.applySystemBarInsets
import io.opengrow.viewmodels.AutoDisplayedNotificationViewModel

const val ARG_NOTIFICATION = "notification"

class AutoDisplayedNotificationFragment(val opengrowService: OpenGrowService) : DialogFragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(notification: Notification, opengrowService: OpenGrowService) =
            AutoDisplayedNotificationFragment(opengrowService).apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(STYLE_NO_TITLE, R.style.OpenGrowFullScreenDialogStyle)
    }
    ...
    private fun setup() {
        viewModel.opengrowService = opengrowService
