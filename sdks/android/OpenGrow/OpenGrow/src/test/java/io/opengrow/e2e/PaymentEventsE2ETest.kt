...
// PURCHASE_EVENT_DISABLED: import io.opengrow.OpenGrow
// PURCHASE_EVENT_DISABLED: import io.opengrow.model.events.PaymentEventType
// PURCHASE_EVENT_DISABLED: import io.opengrow.service.OpenGrowService
...
// PURCHASE_EVENT_DISABLED:         E2ETestUtils.resetOpenGrowSingleton()
...
// PURCHASE_EVENT_DISABLED:
// PURCHASE_EVENT_DISABLED:             OpenGrow.logInAppPurchase(purchaseJson)
// PURCHASE_EVENT_DISABLED:             Shadows.shadowOf(Looper.getMainLooper()).idle()
// PURCHASE_EVENT_DISABLED:
...
// PURCHASE_EVENT_DISABLED:             try {
// PURCHASE_EVENT_DISABLED:                 OpenGrow.logInAppPurchase("not valid json {{{")
// PURCHASE_EVENT_DISABLED:                 Shadows.shadowOf(Looper.getMainLooper()).idle()
// PURCHASE_EVENT_DISABLED:
// PURCHASE_EVENT_DISABLED:                 E2ETestUtils.assertAuthenticationCompleted()
...
// PURCHASE_EVENT_DISABLED:                 startDate = io.opengrow.utils.InstantCompat.now()
// PURCHASE_EVENT_DISABLED:             )
// PURCHASE_EVENT_DISABLED:             Shadows.shadowOf(Looper.getMainLooper()).idle()
// PURCHASE_EVENT_DISABLED:
// PURCHASE_EVENT_DISABLED:             delay(1000)
