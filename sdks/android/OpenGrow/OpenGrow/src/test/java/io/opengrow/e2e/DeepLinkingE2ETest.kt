    ...
    fun `test cold start from deeplink processes link parameter`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/abc123","data":null}""")
        ))
        ...
        var receivedDeeplink: io.opengrow.model.DeeplinkDetails? = null

        val activityController = Robolectric.buildActivity(TestActivity::class.java, deeplinkIntent)
        activityController.create()


        OpenGrow.setOnDeeplinkReceivedListener(activityController.get()) { details ->
        ...
        assertEquals("https://test.opengrow.io/abc123", receivedDeeplink?.link)
    ...
    fun `test cold start from deeplink with custom data processes link`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/campaign","data":{"campaign":"summer","source":"email"}}""")
        ))
    ...
    fun `test warm start activity receives onNewIntent with deeplink`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/warmstart","data":{"ref":"warm"}}""")
        ))
        ...
        assertEquals("https://test.opengrow.io/warmstart", receivedDeeplink?.link)
    ...
    fun `test hot start - link received while app visible triggers processing`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/hotstart","data":{"ref":"hot"}}""")
        ))
        ...
        E2ETestUtils.assertAuthenticationCompleted()
        assertNotNull("Deeplink listener should receive link", receivedDeeplink?.link)
        assertEquals("https://test.opengrow.io/hotstart", receivedDeeplink?.link)
    ...
    fun `test hot start - duplicate intent within 2 seconds ignored`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/duplicate","data":{"ref":"dup"}}""")
        ))
        ...
        E2ETestUtils.assertAuthenticationCompleted()
        assertNotNull("Deeplink listener should receive link", receivedDeeplink?.link)
        assertEquals("https://test.opengrow.io/duplicate", receivedDeeplink?.link)
        assertTrue(
    ...
    fun `test deeplink resolution timeout handled gracefully`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/slow","data":null}""")
    ...
    fun `test listener set after deeplink received still works`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/pending","data":{"ref":"late"}}""")
        ))
        ...
        val openedLink = OpenGrow.openedLinkDetails
        assertNotNull("openedLinkDetails should be set after deeplink resolved", openedLink)
        assertEquals("https://test.opengrow.io/pending", openedLink?.link)
    ...
    fun `test deep link with custom data payload passes data to listener`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/promo","data":{"promo_code":"SUMMER2024","discount":20}}""")
        ))
    ...
    fun `test multiple deep links in quick succession handled correctly`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/resolved","data":{"seq":"multi"}}""")
        ))
        ...
        OpenGrow.onNewIntent(intent1, activityController.get())

        OpenGrow.onNewIntent(intent2, activityController.get())

        OpenGrow.onNewIntent(intent3, activityController.get())
        ...
        assertTrue("All received links should be the resolved URL",
            receivedLinks.all { it == "https://test.opengrow.io/resolved" })
    ...
    fun `test deep link with tracking parameters preserves tracking data`() {
        ...
        E2ETestUtils.setUrlDispatcher(mockWebServer, mapOf(
            ...
            "data_for_device" to MockResponse()
                .setResponseCode(200)
                .setHeader("Content-Type", "application/json")
                .setBody("""{"link":"https://test.opengrow.io/campaign","data":{"product":"premium"},"tracking":{"campaign":"email_blast","source":"newsletter","medium":"email"}}""")
        ))
