...
import io.opengrow.example.ui.theme.OpenGrowTestAppTheme
...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        OpenGrow.setOnDeeplinkReceivedListener(this) { details ->
    ...
    override fun onStart() {
        ...
        OpenGrow.numberOfUnreadMessages(lifecycleOwner = this, onResult = {
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Button(onClick = {
                    OpenGrow.generateLink(title = "Test title",
            ...
            Row(
                ...
                Button(onClick = {
                    ...
                    lastSegment?.let { lastSegment ->
                        OpenGrow.linkDetails(path = lastSegment,
                            lifecycleOwner = activity,
                ...
                Button(onClick = {
                    coroutineScope.launch {
                        try {
                            ...
                            lastSegment?.let { lastSegment ->
                                val response = OpenGrow.linkDetails(path = lastSegment)
