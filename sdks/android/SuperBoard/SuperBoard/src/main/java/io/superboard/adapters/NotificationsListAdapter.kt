package io.superboard.adapters
...
import io.superboard.databinding.LayoutNotificationListItemBinding
import java.lang.IllegalStateException

sealed class NotificationsListItem {
    data class Notification(val item: io.superboard.model.notifications.Notification) : NotificationsListItem()
}
