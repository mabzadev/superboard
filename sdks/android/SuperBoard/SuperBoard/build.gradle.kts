...
android {
    sourceSets {
        getByName("test") {
            java.setSrcDirs(listOf("../../../../tests/checks/sdks/android/library/java", "../../../../tests/checks/sdks/android/library/kotlin"))
            resources.setSrcDirs(listOf("../../../../tests/checks/sdks/android/library/resources"))
        }
    }
