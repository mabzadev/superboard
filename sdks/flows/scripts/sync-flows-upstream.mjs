...
This directory is generated by \`sdks/flows/scripts/sync-flows-upstream.mjs\` from two pinned public
...
function buildManifest(files) {
	return {
		...
		policy: {
			generated_by: "sdks/flows/scripts/sync-flows-upstream.mjs",
