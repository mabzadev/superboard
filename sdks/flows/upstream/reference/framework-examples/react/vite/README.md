...
This example extends the React Router Framework template with the [`@superboard/flows-react`](https://www.npmjs.com/package/@superboard/flows-react) and [`@superboard/flows-react-components`](https://www.npmjs.com/package/@superboard/flows-react-components) packages to demonstrate how to integrate Flows into your application.
...
The `@superboard/flows-react-components` package includes ready-to-use components to build in-app experiences. Refer to [`flows.tsx`](./app/flows.tsx) to learn how to import and use these components.
