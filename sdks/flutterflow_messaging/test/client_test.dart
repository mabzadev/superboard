...
void main() {
  ...
  test('refreshes an expired identity once and retries the failed request', () async {
    var refreshes = 0;
    var requests = 0;
    final client = OpenGrowMessagingClient(
      baseUri: Uri.parse('https://messages.example'),
  ...
  test('exposes read receipts and typing updates with authenticated requests', () async {
    ...
    expect(requests.every((request) => request.headers['x-opengrow-project-id'] == '42'), isTrue);
  });
}
