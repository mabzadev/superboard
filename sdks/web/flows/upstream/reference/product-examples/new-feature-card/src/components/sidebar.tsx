    ...
    <div className="flex flex-col gap-2 md:h-full md:max-w-40 md:flex-1">
      <div className="flex h-full flex-col gap-4 overflow-auto" style={{ scrollbarWidth: "none" }}>
        ...
        <div className="hidden flex-col gap-2 md:flex">
          ...
          <div className="h-2.5 w-full max-w-[102px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
          <div className="h-2.5 w-full max-w-[106px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
          <div className="h-2.5 w-full max-w-[80px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
          <div className="h-2.5 w-full max-w-[88px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
          <div className="h-2.5 w-full max-w-[98px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
          <div className="h-2.5 w-full max-w-[92px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
          <div className="h-2.5 w-full max-w-[72px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
          <div className="h-2.5 w-full max-w-[94px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
          <div className="h-2.5 w-full max-w-[80px] rounded-sm bg-neutral-300 dark:bg-neutral-700" />
        </div>
      </div>
      {/* The NewFeatureCard is inserted into the sidebar slot here */}
