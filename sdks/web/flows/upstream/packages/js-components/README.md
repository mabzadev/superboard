...
```
npm install @superboard/flows-js-components
```

⚠️ This package provides a set of ready-made components for building product adoption. To use it, you also need to install the `@superboard/flows-js` package.
