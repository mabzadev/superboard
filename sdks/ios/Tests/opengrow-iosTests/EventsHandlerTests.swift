...
final class EventsHandlerTests: XCTestCase {
    ...
    func testApplicationWillResignActiveSavesTimestamp() {
        ...
        let savedTimestamp = mockDefaults.store[.opengrowResignTimestamp] ?? 0
    ...
    func testApplicationDidBecomeActiveWithResignTimestampHandlesOldEvents() {
        ...
        mockDefaults.store[.opengrowResignTimestamp] = Date().toSeconds()
    ...
    func testInitIncrementsNumberOfOpens() {
        XCTAssertEqual(mockDefaults.store[.opengrowNumberOfOpens] ?? 0, 0)

        _ = makeHandler()

        XCTAssertEqual(mockDefaults.store[.opengrowNumberOfOpens], 1,
                       "Init should increment numberOfOpens")
    }

    func testInitDoesNotAddInstallEventOnSubsequentOpens() {
        mockDefaults.store[.opengrowNumberOfOpens] = 5
    ...
    func testInitSavesLastStartTimestamp() {
        ...
        let timestamp = mockDefaults.store[.opengrowLastStartTimestamp] ?? 0
    ...
    func testInitAddsReactivationEventAtExactly7Days() {
        ...
        mockDefaults.store[.opengrowLastStartTimestamp] = exactly7DaysAgo.toSeconds()
        mockDefaults.store[.opengrowNumberOfOpens] = 5
    ...
    func testInitDoesNotAddReactivationEventAt6CalendarDays() {
        ...
        mockDefaults.store[.opengrowLastStartTimestamp] = sixDaysAgo.toSeconds()
        mockDefaults.store[.opengrowNumberOfOpens] = 5
    ...
    func testInitAddsReactivationEventWhenLastStartWas8DaysAgo() {
        ...
        mockDefaults.store[.opengrowLastStartTimestamp] = eightDaysAgo.toSeconds()
        mockDefaults.store[.opengrowNumberOfOpens] = 5
    ...
    func testHandleOldEngagementEventsCalculatesEngagementTime() {
        ...
        mockDefaults.store[.opengrowResignTimestamp] = resignDate.toSeconds()
