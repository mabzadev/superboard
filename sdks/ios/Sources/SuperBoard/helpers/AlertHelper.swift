...
struct ButtonAction {
    ...
    let action: SuperBoardEmptyClosure? // The closure to be executed when the button is tapped.
}
...
class AlertHelper {
    ...
    static func displayMessageOnTopOfEverything(_ message: String, title: String, completion: SuperBoardEmptyClosure? = nil) {
