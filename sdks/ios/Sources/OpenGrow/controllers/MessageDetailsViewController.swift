...
class MessageDetailsViewController: UIViewController, WKNavigationDelegate, WKUIDelegate {
    ...
    var notification: OpenGrowNotification?  // The notification to display.
    weak var manager: OpenGrowManager? // The manager responsible for marking the notification as read.
