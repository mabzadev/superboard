...
class MessagesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate {
    ...
    weak var manager: OpenGrowManager?  // The manager responsible for fetching notifications.
    var dismissalDelegate: DismissalDelegate?

    private var notifications = [OpenGrowNotification]() {  // Array of notifications to be displayed.
        didSet {
    ...
    private func goToMessage(notification: OpenGrowNotification) {
