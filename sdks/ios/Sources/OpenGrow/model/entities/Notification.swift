...
struct OpenGrowNotification: Codable {
...
extension OpenGrowNotification {
...
struct OpenGrowNotificationsResponse: Codable {
    let notifications: [OpenGrowNotification]  // Array of notifications.
}
