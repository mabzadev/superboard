...
class PaymentEventsStorage: PaymentEventsStorageProtocol {
    ...
    private struct Constants {
        static let userDefaultsKey = "com.opengrow.handled-transaction-ids"
        static let migrationDoneKey = "com.opengrow.payment-storage-migrated"
        static let pendingTransactionsKey = "com.opengrow.pending-transactions"
        static let legacyCacheName = "opengrow-payment-events-cache"
    ...
    private let queue = DispatchQueue(label: "com.opengrow.paymentEventsStorage")
