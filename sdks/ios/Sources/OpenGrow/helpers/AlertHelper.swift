...
struct ButtonAction {
    ...
    let action: OpenGrowEmptyClosure? // The closure to be executed when the button is tapped.
}
...
class AlertHelper {
    ...
    static func displayMessageOnTopOfEverything(_ message: String, title: String, completion: OpenGrowEmptyClosure? = nil) {
