...
const NativeModule = TurboModuleRegistry.get<Spec>('OpenGrowWrapper');
...
export class TurboModuleOpenGrow {
  // Simple methods
  ...
  async generateLink(
    ...
    if (!NativeModule) {
      throw new Error('Native module OpenGrowWrapper is not linked');
    }
...
export default new TurboModuleOpenGrow();
