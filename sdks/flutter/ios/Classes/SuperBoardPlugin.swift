...
public class SuperBoardPlugin: NSObject, FlutterPlugin {
    private var eventSink: FlutterEventSink?
    private var methodChannel: FlutterMethodChannel?
    
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "superboard", binaryMessenger: registrar.messenger())
        let eventChannel = FlutterEventChannel(name: "superboard/deeplinks", binaryMessenger: registrar.messenger())
        
        let instance = SuperBoardPlugin()
...
extension SuperBoardPlugin: FlutterStreamHandler {
