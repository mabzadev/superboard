...
public class OpenGrowPlugin: NSObject, FlutterPlugin {
    private var eventSink: FlutterEventSink?
    private var methodChannel: FlutterMethodChannel?
    
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "opengrow", binaryMessenger: registrar.messenger())
        let eventChannel = FlutterEventChannel(name: "opengrow/deeplinks", binaryMessenger: registrar.messenger())
        
        let instance = OpenGrowPlugin()
...
extension OpenGrowPlugin: OpenGrowDelegate {
...
extension OpenGrowPlugin: FlutterStreamHandler {
