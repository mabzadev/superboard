...
/// Represents the details of a deeplink received from OpenGrow
...
/// Parameters for generating a OpenGrow link
...
/// Exception thrown by OpenGrow SDK
class OpenGrowException implements Exception {
  final String message;
  final String? code;

  OpenGrowException(this.message, {this.code});

  @override
  String toString() =>
      'OpenGrowException: $message${code != null ? ' (code: $code)' : ''}';
}
