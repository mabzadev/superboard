...
A demo project is included in [`sdks/flutter/native/android/SuperBoard/app`](https://github.com/mabzadev/superboard/tree/dev/sdks/flutter/native/android/SuperBoard/app).
