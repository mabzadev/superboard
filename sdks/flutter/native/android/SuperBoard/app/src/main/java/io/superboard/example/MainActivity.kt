...
import io.superboard.example.ui.theme.SuperBoardTestAppTheme
...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        SuperBoard.setOnDeeplinkReceivedListener(this) { details ->
    ...
    override fun onStart() {
        ...
        SuperBoard.numberOfUnreadMessages(lifecycleOwner = this, onResult = {
    ...
    Box(
        ...
        Column(
            ...
            Row(
                ...
                Button(onClick = {
                    SuperBoard.generateLink(title = "Test title",
            ...
            Row(
                ...
                Button(onClick = {
                    ...
                    lastSegment?.let { lastSegment ->
                        SuperBoard.linkDetails(path = lastSegment,
                            lifecycleOwner = activity,
                ...
                Button(onClick = {
                    coroutineScope.launch {
                        try {
                            ...
                            lastSegment?.let { lastSegment ->
                                val response = SuperBoard.linkDetails(path = lastSegment)
