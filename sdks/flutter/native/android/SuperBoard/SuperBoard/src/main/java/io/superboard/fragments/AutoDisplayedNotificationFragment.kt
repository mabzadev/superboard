...
import io.superboard.databinding.FragmentAutoDisplayedNotificationBinding
...
import io.superboard.viewmodels.AutoDisplayedNotificationViewModel

const val ARG_NOTIFICATION = "notification"

class AutoDisplayedNotificationFragment(val superboardService: SuperBoardService) : DialogFragment() {
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(notification: Notification, superboardService: SuperBoardService) =
            AutoDisplayedNotificationFragment(superboardService).apply {
