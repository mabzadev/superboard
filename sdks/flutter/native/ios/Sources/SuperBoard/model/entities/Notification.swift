...
struct SuperBoardNotification: Codable {
...
extension SuperBoardNotification {
...
struct SuperBoardNotificationsResponse: Codable {
    let notifications: [SuperBoardNotification]  // Array of notifications.
}
