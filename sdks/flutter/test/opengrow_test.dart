...
void main() {
  final OpenGrowPlatform initialPlatform = OpenGrowPlatform.instance;

  test('$MethodChannelOpenGrow is the default instance', () {
    expect(initialPlatform, isInstanceOf<MethodChannelOpenGrow>());
  });

  test('getPlatformVersion', () async {
    OpenGrow opengrowPlugin = OpenGrow();
    MockOpenGrowPlatform fakePlatform = MockOpenGrowPlatform();
    OpenGrowPlatform.instance = fakePlatform;
