...
/** OpenGrowPlugin */
class OpenGrowPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "opengrow")
        channel.setMethodCallHandler(this)
        
        eventChannel = EventChannel(flutterPluginBinding.binaryMessenger, "opengrow/deeplinks")
    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        when (call.method) {
            ...
            "setDebugLevel" -> {
                ...
                try {
                    // Convert string to OpenGrow debug level
                    // Note: You may need to adjust this based on the actual OpenGrow SDK API
