...
test("the internal Support reference has exactly 758 mapped route records", () => {
	const manifest = JSON.parse(
		readFileSync(resolve(root, "scripts/support-audit/reference-routes.json"), "utf8"),
	);
	const capabilities = JSON.parse(
		readFileSync(resolve(root, "scripts/support-audit/capabilities.json"), "utf8"),
	);
...
test("the Support parity and publication gates pass", () => {
	for (const script of [
		"scripts/support-parity-check.mjs",
		"scripts/support-public-leak-check.mjs",
	]) {
...
test("the publication gate rejects migration vocabulary from a published Support surface", (context) => {
	...
	const supportDirectory = join(
		fixtureRoot,
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plugmod-support/source/components/modules",
	);
	mkdirSync(auditDirectory, { recursive: true });
