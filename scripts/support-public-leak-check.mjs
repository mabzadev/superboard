...
const sources = [
	...
	"packages/supbrd-runtime-plugins/src/front/client",
...
const artifactSources = [
	...
	"packages/supbrd-runtime-plugins/dist/front/client",
];
const failures = [];
...
function isPublishedSupportSurface(file) {
	return (
		file.startsWith("workers/support/src/") ||
		/^workers\/api\/src\/lib\/support-gateway(?:\.|\/)/u.test(file) ||
		file.startsWith(
			"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plugmod-support/",
		) ||
