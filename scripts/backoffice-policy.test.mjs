...
test("each target has one explicit automatic Cloudflare deployment authority", () => {
	...
	const deploymentMatrix = JSON.parse(read("config/cloudflare-deployments.json"));
...
test("runtime and plugin Front do not expose legacy OpenGrow SaaS controls", () => {
	const runtimeFiles = [
		...
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-settings/source/app/(protected)/project-settings/page.tsx",
	];
	const forbidden = [
	...
	for (const removedPath of [
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-settings/source/components/settings/PlanSection.tsx",
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-settings/source/components/settings/EnterpriseDialog.tsx",
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-settings/source/hooks/queries/usePaymentsQueries.ts",
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-settings/source/api/payments/paymentsService.ts",
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-settings/source/lib/edition.ts",
	]) {
...
test("copyable SDK setup uses target-owned public origins", () => {
	const setup = read(
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plug-settings/source/components/app/SdkSetupWizard.tsx",
	);
	const preview = read(
		"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plugmod-dynamic-links/source/components/dynamic_links/social-preview/SocialPreviewPageContent.tsx",
	);
...
test("Site and Front ship without PostHog runtime or environment variables", () => {
	...
	for (const path of [
		...
		...sourceFiles("packages/supbrd-runtime-plugins/src/front"),
	])
...
test("back-office health includes transactional, newsletter and delivery-job state", () => {
	...
	assert.match(
		read(
			"packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plugmod-observability/source/app/(protected)/infrastructure/page.tsx",
		),
		/Background jobs/u,
	);
});
