...
const githubPackagesTokenEnvironmentVariable = "SUPERBOARD_GITHUB_PACKAGES_TOKEN";
const githubPackagesUserEnvironmentVariable = "SUPERBOARD_GITHUB_PACKAGES_USER";
...
async function validateFlutterFlowSurface(catalog, errors, manifestOverride) {
	const manifest =
		manifestOverride ??
		JSON.parse(
			await readFile(resolve(root, "scripts/config/flutterflow-custom-code.json"), "utf8"),
		);
