...
test("active production binds routing to the declared application receipt", async () => {
	...
	assert.deepEqual(calls, [
		{
			manifestPath: "/repository/config/flutterflow-sources/reference-production.json",
			receiptPath: "/repository/config/flutterflow-releases/reference-production.json",
		},
	]);
