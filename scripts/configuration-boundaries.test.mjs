...
test("generated native dependency trees never enter the shared source audit", () => {
	const contract = {
		scan: {
			ignoredDirectoryNames: [".build", ".gradle", ".swiftpm", "DerivedData", "Pods", "build"],
		},
	};
...
test("the public short-link social preview never constructs an HTTP URL", async () => {
	const source = await readFile(
		new URL(
			"../packages/supbrd-runtime-plugins/src/front/client/plugins/supbrd-plugmod-analytics/source/components/dynamic_links/links/create_link/CreateLinkSocialMediaPreview.tsx",
			import.meta.url,
		),
		"utf8",
	);
