 ...
 *
 * Usage:
 *   node scripts/emdash/sync-templates-repo.mjs           # full run: clone, sync, PR
 *   node scripts/emdash/sync-templates-repo.mjs --dry-run  # sync to temp dir, print diff, don't push
 *   node scripts/emdash/sync-templates-repo.mjs --local /path/to/repo  # sync to a local checkout
 */
...
const EXCLUDE = new Set([
	...
	// sync-template-skills.sh script concatenates with scripts/emdash/agents-base.md
...
try {
	...
	const prBody = [
		...
		"",
		"Auto-generated by `scripts/emdash/sync-templates-repo.mjs`.",
	].join("\n");
