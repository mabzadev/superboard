...
import { isIgnoredDirectory, isLocalOnly } from "./configuration-boundaries.mjs";
...
const configurationBoundaryContract = JSON.parse(
	readFileSync(resolve(root, "config/configuration-boundaries.json"), "utf8"),
);
...
test("portable runtime sources never pin an application domain, account id, or workstation path", () => {
	...
	const roots = ["apps/site/src", "apps/mcp/src", "packages", "scripts", "sdks", "workers"];
	let checked = 0;
