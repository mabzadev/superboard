...
const workerDirectory = managedWorker
	...
	: service === "custom"
		...
		: service === "site"
			...
			: resolve(root, servicePackagePath(service));
...
const generatedPath = resolve(workerDirectory, ".worker-configuration.generated.d.ts");
try {
	run(
		"npx",
		[
	...
	let generated = (await readFile(generatedPath, "utf8"))
		.replaceAll(configPath, `infra/generated/${targetName}-${service}-${environment}.jsonc`)
	...
	if (service === "email") {
		generated = [
			...
			generated
				...
				.replace("\tMAIL_PROVIDER: string;", '\tMAIL_PROVIDER: "smtp" | "aws-ses";'),
		].join("\n");
	}
	await writeFile(
		outputPath,
