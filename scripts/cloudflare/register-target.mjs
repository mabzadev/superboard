...
import { environmentFromArgs, parseArgs, root, validateTarget } from "./target.mjs";
...
const confirmation = typeof args.confirm === "string" ? args.confirm.trim() : "";
...
const manifestPath = resolve(root, "infra", "targets", `${target}.json`);
