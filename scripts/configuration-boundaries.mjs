...
import { DOMAIN_SERVICE_REGISTRY, PLATFORM_SERVICE_SECRETS } from "./cloudflare-services.mjs";
...
function addExact(records, value, kind, target) {
	if (typeof value !== "string" || value.length < 8 || value === "opengrow") return;
