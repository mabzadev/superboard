...
pnpm cloudflare:deploy:all --target mbza-development --environment development --prepared-deployment infra/generated/mbza-development-development-deployments.json
```
