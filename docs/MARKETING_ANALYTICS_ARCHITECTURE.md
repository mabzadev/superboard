...
Le Worker `packages/plugins/superboard-analytics/worker` est l'autorité pour :
...
Le Worker `packages/plugins/superboard-communication/marketing` reste l'autorité pour :
