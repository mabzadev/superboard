...
| ----------------------------- | ------------------------------------------ | ------------------------------------------ | -------------------------------------- |
| `grovs-io/backend`            | `6a20f36994ca587cdeb554e08a25689c4f5240e8` | `9d0be511b6da74854253a2b1dbe8a96125324064` | `packages/plugins/superboard-core/api` |
...
installations converge through `0010_superboard_identity.sql` and secure OAuth
rotation.
