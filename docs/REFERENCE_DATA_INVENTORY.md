...
| Marketing     | `/marketing/campaigns`, `/marketing/email`, `/marketing/in-app-messages`, `/marketing/journeys`, `/marketing/channels`, `/marketing/settings`, `/marketing/statistics`                                         |
| Analytics     | `/analytics`, `/analytics/events`, `/analytics/installations`, `/analytics/purchases`, `/analytics/insights`, `/analytics/reports`                                                                             |
...
| Analytics        | `analytics_audit_events`, `analytics_daily_metrics`, `analytics_dead_letters`, `analytics_event_receipts`, `analytics_events_hot`, `analytics_idempotency_keys`, `analytics_identity_aliases`, `analytics_ingest_outbox`, `analytics_installations`, `analytics_marketing_signal_outbox`, `analytics_operation_jobs`, `analytics_profiles`, `analytics_projection_receipts`, `analytics_project_settings`, `analytics_purchase_facts`, `analytics_saved_reports`, `analytics_sessions`, `analytics_subject_event_index`                                                                                                                  |
