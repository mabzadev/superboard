...
import GrovsIcon from "@/assets/icons/ads_platform/grovs.svg";
...
function McpAuthorizeContent() {
  ...
  const clientDisplayName = clientName || "the application";
  ...
  return (
    <div className="bg-muted flex min-h-svh flex-col items-center justify-center w-full p-4">
      <Card className="w-full max-w-[420px] shadow-lg">
        <CardHeader className="flex flex-col items-center gap-3 pb-2">
          <Image src={GrovsIcon} alt="Grovs" width={44} height={44} />
          <div className="flex flex-col items-center gap-1 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              wants to access your Grovs account.
            </p>
          </div>
        </CardHeader>
