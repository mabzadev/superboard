# OpenGrow Reference security policy

The reference application validates OpenGrow's common FlutterFlow and Flutter
...
`mbzadev/opengrow-reference`. Do not publish credentials, user data, access
