...
import { renderReleaseActivationConsole } from "../../../../apps/site/src/lib/release-activation-console.js";
...
describe("Release Activation console", () => {
	test("shows the exact compare-and-swap command without approval controls", () => {
		const html = renderReleaseActivationConsole({
			...
			content_checksum: "sha256:eb0ef00cebd27ca732bcdce17a0593ec8249292ff65eb0782266fcbbf18c86ed",
