...
import { initializeOperatorProjectScope } from "../../../../../apps/site/src/lib/operator-project-scope.js";
import adapters from "../../../../../scripts/config/superboard-plugin-api-adapters.json";
...
export function proveApi(
	...
	const proof = {
		...
		test: `tests/checks/apps/site/runtime/${testFile}`,
