...
import { editableViewFromEntry } from "../../../../apps/site/src/lib/native-front-views.js";
import parityRelease from "../../../../scripts/config/superboard-parity-release.json";
import independenceBaseline from "../../../../scripts/config/superboard-plugin-independence-baseline.json";
