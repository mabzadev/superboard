...
import {
	drainBackfillDeadLetterBatch,
	processBackfillBatch,
} from "../../../../apps/aggregator/src/backfill-consumer.js";
import {
...
} from "../../../../apps/aggregator/src/backfill.js";
import { WANTED_COLLECTIONS } from "../../../../apps/aggregator/src/constants.js";
import {
	type CachedDidDoc,
	type DidDocCache,
	type DidDocumentResolverLike,
	DidResolver,
} from "../../../../apps/aggregator/src/did-resolver.js";
import type { BackfillJob, RecordsJob } from "../../../../apps/aggregator/src/env.js";
import type { MessageController } from "../../../../apps/aggregator/src/records-consumer.js";
...
describe("processBackfillJob", () => {
	...
	it("end-to-end against the production D1 cache: DID is registered in known_publishers", async () => {
		const queue = new CapturingRecordsQueue();
		const { createD1DidDocCache } = await import("../../../../apps/aggregator/src/did-resolver.js");
