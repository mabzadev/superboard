...
import type { RecordsJob } from "../../../../apps/aggregator/src/env.js";
import { readLabelCursor } from "../../../../apps/aggregator/src/label-ingestion.js";
import {
	enforceRequiredLabelSourceHealth,
	markLabelSourceHealthy,
	REQUIRED_LABEL_SOURCE_HEALTH_TIMEOUT_MS,
	stageLabelSourceReplay,
} from "../../../../apps/aggregator/src/label-source-health.js";
import {
	activateLabelSourceAfterReplay,
	readLabelSourceTrust,
} from "../../../../apps/aggregator/src/label-source-policy.js";
import { upsertHydratedLabelState } from "../../../../apps/aggregator/src/label-state.js";
import {
	isCurrentSubject,
	listCurrentSubjects,
} from "../../../../apps/aggregator/src/labeler-reconciliation-service.js";
import {
	getListingPolicy,
	packageProfileUri,
	type ListingPolicyMode,
} from "../../../../apps/aggregator/src/listing-policy.js";
import type { VerifiedPdsRecord } from "../../../../apps/aggregator/src/pds-verify.js";
import { enforcePublicProjectionPolicy } from "../../../../apps/aggregator/src/projection-enforcement.js";
import {
	rebuildPublicProjection,
	StaleProjectionRebuildError,
} from "../../../../apps/aggregator/src/public-projection.js";
import {
	applyDelete,
	ingestPackageProfile,
	ingestPackageRelease,
} from "../../../../apps/aggregator/src/records-consumer.js";
import { handleXrpc } from "../../../../apps/aggregator/src/routes/xrpc/router.js";
