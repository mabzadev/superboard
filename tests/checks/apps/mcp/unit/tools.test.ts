...
import { ApiError } from "../../../../../apps/mcp/src/api-client.js";
import {
	statusEmpty,
	platformStatus,
	createdLink,
...
vi.mock("../../../../../apps/mcp/src/api-client.js", () => ({
...
const api = await import("../../../../../apps/mcp/src/api-client.js");
const {
	handleGetStatus,
...
} = await import("../../../../../apps/mcp/src/tools/handlers.js");
const { runWithAuth } = await import("../../../../../apps/mcp/src/server.js");
import type { ToolExtra } from "../../../../../apps/mcp/src/server.js";
...
const { format } = await import("../../../../../apps/mcp/src/tools/handlers.js");
