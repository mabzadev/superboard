...
import { App } from "../../../../../apps/labeler/src/admin/App.js";
// @ts-ignore -- Lingui generates this module before the UI test runs.
import { messages } from "../../../../../apps/labeler/src/admin/locales/en/messages.mjs";
...
vi.mock("../../../../../apps/labeler/src/admin/api.js", () => api);
