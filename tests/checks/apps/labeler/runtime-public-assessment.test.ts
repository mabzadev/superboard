...
import { IMAGE_PROMPT_HASH, TEXT_PROMPT_HASH } from "../../../../apps/labeler/src/ai/prompts.js";
import { handlePublicAssessmentXrpc } from "../../../../apps/labeler/src/public-assessment.js";
...
beforeAll(() => {
	for (const migration of ["0001_initial.sql", "0002_finding_identity.sql"]) {
		sqlite.exec(
			readFileSync(
				fileURLToPath(
					new URL(`../../../../apps/labeler/migrations/${migration}`, import.meta.url).href,
				),
				"utf8",
			),
		);
