...
// PURCHASE_EVENT_DISABLED: import io.superboard.SuperBoard
// PURCHASE_EVENT_DISABLED: import io.superboard.model.events.PaymentEventType
// PURCHASE_EVENT_DISABLED: import io.superboard.service.SuperBoardService
...
// PURCHASE_EVENT_DISABLED:         E2ETestUtils.resetSuperBoardSingleton()
...
// PURCHASE_EVENT_DISABLED:
// PURCHASE_EVENT_DISABLED:             SuperBoard.logInAppPurchase(purchaseJson)
// PURCHASE_EVENT_DISABLED:             Shadows.shadowOf(Looper.getMainLooper()).idle()
// PURCHASE_EVENT_DISABLED:
...
// PURCHASE_EVENT_DISABLED:             try {
// PURCHASE_EVENT_DISABLED:                 SuperBoard.logInAppPurchase("not valid json {{{")
// PURCHASE_EVENT_DISABLED:                 Shadows.shadowOf(Looper.getMainLooper()).idle()
// PURCHASE_EVENT_DISABLED:
// PURCHASE_EVENT_DISABLED:                 E2ETestUtils.assertAuthenticationCompleted()
...
// PURCHASE_EVENT_DISABLED:                 startDate = io.superboard.utils.InstantCompat.now()
// PURCHASE_EVENT_DISABLED:             )
// PURCHASE_EVENT_DISABLED:             Shadows.shadowOf(Looper.getMainLooper()).idle()
// PURCHASE_EVENT_DISABLED:
// PURCHASE_EVENT_DISABLED:             delay(1000)
