...
} from "../../../../../../../sdks/identity/web/src/flows/exchangeTokenByAuthCode";
import { postTokenByAuthCode } from "../../../../../../../sdks/identity/web/src/requests";

// ----------------------------------------------------------------------------
// Mock the external dependency that makes the HTTP call.
// ----------------------------------------------------------------------------
vi.mock("../../../../../../../sdks/identity/web/src/requests", () => ({
