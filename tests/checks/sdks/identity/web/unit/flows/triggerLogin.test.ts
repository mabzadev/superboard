...
import { triggerLogin } from "../../../../../../../sdks/identity/web/src/flows/triggerLogin";
import {
	genCodeVerifierAndChallenge,
	genAuthorizeState,
} from "../../../../../../../sdks/identity/web/src/generators";
import { getAuthorize } from "../../../../../../../sdks/identity/web/src/requests";

// Mock dependencies
vi.mock("../../../../../../../sdks/identity/web/src/requests", () => ({ getAuthorize: vi.fn() }));

vi.mock("../../../../../../../sdks/identity/web/src/generators", () => ({
