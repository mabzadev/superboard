...
import { CookieStorage } from "../../../../../../../../sdks/web/identity/nextjs/src/storage/cookieAdapter";
...
describe("CookieStorage", () => {
	...
	describe("getItem", () => {
		...
		it("should pass request and response options", () => {
	...
	describe("removeItem", () => {
		...
		it("should pass request and response when removing", () => {
			const mockReq = {} as any;
			const mockRes = {} as any;
	...
	describe("integration with shared CookieStorage", () => {
		it("should properly wrap shared storage methods", () => {
			const storage = new CookieStorage();
