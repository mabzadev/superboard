...
const packageJson = JSON.parse(
	await readFile(new URL("../../../../sdks/javascript/package.json", import.meta.url), "utf8"),
);
...
test("the published package keeps its public name and explicit dual-module exports", () => {
	assert.equal(packageJson.name, "@mbzadev/superboard-js-sdk");
	assert.deepEqual(packageJson.exports, {
		".": {
			types: "./dist/index.d.ts",
			import: "./dist/superboard.js",
			require: "./dist/superboard.umd.cjs",
			default: "./dist/superboard.js",
		},
		"./support": {
...
test("the first-party check audits production and development dependencies", () => {
	...
	assert.equal(packageJson.scripts.audit, "npm run audit:production && npm run audit:development");
