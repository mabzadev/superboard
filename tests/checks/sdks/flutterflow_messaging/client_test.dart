...
import 'package:superboard_flutterflow_messaging/superboard_flutterflow_messaging.dart';
...
void main() {
  ...
  test('sends application identity and project headers', () async {
    final client = SuperBoardMessagingClient(
      ...
      httpClient: MockClient((request) async {
        ...
        expect(request.headers['x-superboard-project-id'], '11');
  ...
  test(
    ...
    () async {
      ...
      expect(
        requests.every(
          (request) => request.headers['x-superboard-project-id'] == '42',
        ),
        isTrue,
      );
    },
