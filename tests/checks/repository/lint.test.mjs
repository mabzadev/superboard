...
test("standalone Front lint keeps TypeScript, hooks and accessibility checks without the retired application", async (context) => {
	...
	mkdirSync(join(fixture, "tests/lints"), { recursive: true });
	...
	copyFileSync(
		join(repository, "tests/lints/frontend.config.mjs"),
		join(fixture, "tests/lints/frontend.config.mjs"),
	);
	const lint = new ESLint({
		cwd: fixture,
		overrideConfigFile: join(fixture, "tests/lints/frontend.config.mjs"),
	});
