...
test("reusable platform source and examples contain no application hostname or embedded project key", () => {
	const reusableFiles = [
		...new Set([
			...
			...sourceFiles("sdks/flutter/native/ios/Sources"),
			...sourceFiles("sdks/flutter/native/android/SuperBoard/SuperBoard/src/main"),
			...sourceFiles("sdks/web/src"),
			...sourceFiles("sdks/tauri/src"),
			"package.json",
			"apps/site/package.json",
			"apps/site/public/robots.txt",
			"sdks/flutter/native/android/README.md",
			"sdks/flutter/README.md",
			"sdks/flutter/native/ios/README.md",
			"sdks/web/README.md",
