...
vi.mock(
	"../../../../../../../../packages/plugins/superboard-monetization/src/front/billing/transport.js",
	() => ({
...
} from "../../../../../../../../packages/plugins/superboard-monetization/src/front/billing/api/billing/billingService.js";
...
describe("billing customer administration service", () => {
	...
	it("uses only audited customer mutation routes", async () => {
		...
		expect(requests.post.mock.calls).toEqual([
			["/api/v2/purchases/projects/project-1/customers/customer-1/block", { blocked: true }],
			[
