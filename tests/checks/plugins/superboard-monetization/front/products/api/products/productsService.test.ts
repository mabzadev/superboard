...
vi.mock(
	"../../../../../../../../packages/plugins/superboard-monetization/src/front/products/transport.js",
	() => ({
		GET: requests.get,
		POST: requests.post,
		PUT: requests.put,
...
import {
	...
	updateOffering,
	updatePackage,
} from "../../../../../../../../packages/plugins/superboard-monetization/src/front/products/api/products/productsService.js";
