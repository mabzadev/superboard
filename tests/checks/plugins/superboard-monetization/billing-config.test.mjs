...
import { assertBillingConfigOwnership } from "../../../../packages/plugins/superboard-monetization/scripts/billing-config.mjs";
...
function config({
	...
	return {
		...
		queues: {
			producers: producer ? [{ binding: "BILLING_QUEUE", queue: resources.queues.billing }] : [],
			consumers,
		},
