...
} from "../../../../../../packages/plugins/superboard-analytics/src/front/hooks/queries/useDashboardQueries.js";
import type { DateRangeQuery } from "../../../../../../packages/supbrd-front-ui/src/shared/types/index.js";
...
vi.mock(
	"../../../../../../packages/plugins/superboard-analytics/src/front/api/dashboard/dashboardService.js",
	() => ({
...
} from "../../../../../../packages/plugins/superboard-analytics/src/front/api/dashboard/dashboardService.js";
...
describe("useDashboardQueries", () => {
	...
	describe("useMetricsOverviewQuery", () => {
		it("is disabled when params is null", () => {
			const { result } = renderHook(() => useMetricsOverviewQuery("proj-1", null), {
				wrapper: createWrapper(queryClient),
			});
			expect(result.current.fetchStatus).toBe("idle");
		});
