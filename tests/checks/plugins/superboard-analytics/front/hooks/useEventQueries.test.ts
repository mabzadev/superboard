...
} from "../../../../../../packages/plugins/superboard-core/src/front/settings/hooks/queries/useEventQueries.js";
import type {
	EventsSearchPayload,
	EventsSortedPayload,
	DateRangeQuery,
} from "../../../../../../packages/supbrd-front-ui/src/shared/types/index.js";
...
vi.mock(
	"../../../../../../packages/plugins/superboard-core/src/front/settings/api/events/eventsService.js",
	() => ({
...
} from "../../../../../../packages/plugins/superboard-core/src/front/settings/api/events/eventsService.js";
...
describe("useEventQueries", () => {
	...
	describe("useEventsSearchQuery", () => {
		...
		it("is disabled when params is null", () => {
			const { result } = renderHook(() => useEventsSearchQuery("proj-1", null), {
				wrapper: createWrapper(queryClient),
			});
			expect(result.current.fetchStatus).toBe("idle");
		});
	...
	describe("useEventsSortedQuery", () => {
		it("is disabled when params is null", () => {
			const { result } = renderHook(() => useEventsSortedQuery("proj-1", null), {
				wrapper: createWrapper(queryClient),
			});
			expect(result.current.fetchStatus).toBe("idle");
		});
	...
	describe("useEventsOverviewQuery", () => {
		it("is disabled when params is null", () => {
			const { result } = renderHook(() => useEventsOverviewQuery("proj-1", null), {
				wrapper: createWrapper(queryClient),
			});
			expect(result.current.fetchStatus).toBe("idle");
		});
	...
	describe("useEventsPaymentQuery", () => {
		it("is disabled when params is null", () => {
			const { result } = renderHook(() => useEventsPaymentQuery("proj-1", null), {
				wrapper: createWrapper(queryClient),
			});
			expect(result.current.fetchStatus).toBe("idle");
		});
