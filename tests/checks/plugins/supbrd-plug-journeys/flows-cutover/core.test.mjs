...
} from "../../../../../packages/plugins/supbrd-plug-journeys/scripts/flows-cutover/adapters.mjs";
import {
	canonicalJson,
	sha256,
} from "../../../../../packages/plugins/supbrd-plug-journeys/scripts/flows-cutover/core-primitives.mjs";
import {
...
} from "../../../../../packages/plugins/supbrd-plug-journeys/scripts/flows-cutover/core.mjs";
import {
	FLOW_CUTOVER_ENTITIES,
	FLOW_CUTOVER_ENTITY_BY_ID,
	FLOW_SOURCE_QUERIES,
} from "../../../../../packages/plugins/supbrd-plug-journeys/scripts/flows-cutover/registry.mjs";
...
test("the complete generated import executes twice with identical raw ids isolated across projects", async () => {
	...
	try {
		const migrationDirectory = resolve("packages/plugins/supbrd-plug-journeys/flows/migrations");
