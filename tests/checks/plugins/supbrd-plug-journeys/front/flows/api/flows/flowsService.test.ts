...
vi.mock(
	"../../../../../../../../packages/plugins/supbrd-plug-journeys/src/front/flows/transport.js",
	() => ({
		GET: requests.get,
		POST: requests.post,
...
import {
	flowsApi,
	type FlowGraph,
} from "../../../../../../../../packages/plugins/supbrd-plug-journeys/src/front/flows/api/flows/flowsService.js";
