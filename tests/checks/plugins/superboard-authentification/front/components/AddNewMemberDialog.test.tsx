...
import AddNewMemberDialog from "../../../../../../packages/plugins/superboard-core/src/front/settings/components/settings/AddNewMemberDialog.js";
import { render, screen, fireEvent, waitFor } from "../../../../packages/supbrd-front-ui/render.js";
...
describe("AddNewMemberDialog", () => {
	...
	it("calls handleInviteMember with email and role on submit", async () => {
		...
		render(<AddNewMemberDialog {...defaultProps} handleInviteMember={handleInviteMember} />);
		...
		expect(handleInviteMember).toHaveBeenCalledWith("test@example.com", "member");
	});
