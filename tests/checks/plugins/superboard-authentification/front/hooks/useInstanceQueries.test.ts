...
} from "../../../../../../packages/plugins/superboard-core/src/front/settings/hooks/queries/useInstanceQueries.js";
import { renderHook, waitFor } from "../../../../packages/supbrd-front-ui/render.js";
import { createTestQueryClient } from "../../../superboard-acquisition/front/dynamic-links/hooks/query-test-utils.js";

vi.mock(
	"../../../../../../packages/plugins/superboard-core/src/front/settings/api/instances/instanceService.js",
	() => ({
...
vi.mock(
	"../../../../../../packages/plugins/superboard-core/src/front/settings/api/applications/configApplicationsService.js",
	() => ({
...
import { getProjectConfigurationAPICall } from "../../../../../../packages/plugins/superboard-core/src/front/settings/api/applications/configApplicationsService.js";
import {
	getInstancesAPICall,
...
} from "../../../../../../packages/plugins/superboard-core/src/front/settings/api/instances/instanceService.js";
...
describe("useInstanceQueries", () => {
	...
	describe("useSetupProgressQuery", () => {
		it("is disabled when instanceId is undefined", () => {
			const { result } = renderHook(() => useSetupProgressQuery(undefined, "ios"), {
				wrapper: createWrapper(queryClient),
			});
			expect(result.current.fetchStatus).toBe("idle");
		});
		...
		it("fetches setup progress data", async () => {
			...
			const { result } = renderHook(() => useSetupProgressQuery("inst-1", "ios"), {
				wrapper: createWrapper(queryClient),
			});
