...
import UpdateInfo from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/blocks/UpdateInfo";
import { updateInfo } from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/tools/locale";
...
describe("UpdateInfo Component", () => {
	...
	const setup = (props = defaultProps) => {
		...
		render(<UpdateInfo {...props} />, container);
	...
	it("renders success message when success is true", () => {
		...
		const successMessage = getByText(container, updateInfo.success.en);
		expect(successMessage).toBeDefined();
	});

	it("renders title, form fields and redirect link", () => {
		const container = setup();
		const title = getByText(container, updateInfo.title.en);
		...
		const confirmButton = getByText(container, updateInfo.confirm.en);
		expect(confirmButton).toBeDefined();

		const redirectLink = getByText(container, updateInfo.redirect.en);
	...
	it("calls handleChange when firstName and lastName fields change", () => {
		const container = setup();
		const firstNameInput = container.querySelector('input[name="firstName"]') as HTMLInputElement;
		const lastNameInput = container.querySelector('input[name="lastName"]') as HTMLInputElement;
