...
import usePasskeyVerifyForm from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/hooks/usePasskeyVerifyForm";
...
describe("usePasskeyVerifyForm hook", () => {
	const locale = "en";
	...
	test("should not fetch passkey options if allowPasskey is false", async () => {
	...
	test("should fetch passkey options if allowPasskey is true", async () => {
	...
	test("should call onSubmitError when fetching passkey options fails", async () => {
	...
	test("should set passkeyOption to false if response does not contain passkeyOption", async () => {
		const fakeResponse = {
			ok: true,
			json: async () => ({}),
		};
	...
	test("handleVerifyPasskey does nothing if passkeyOption is null", () => {
		const { result } = renderHook(() =>
			usePasskeyVerifyForm({
				locale,
				onSubmitError,
	...
	test("handleVerifyPasskey calls startAuthentication and submitPasskey on success", async () => {
		const fakePasskeyOption = {
			challenge: "test-challenge",
			rpId: "test-rp",
		};
	...
	test("handleVerifyPasskey does not continue if startAuthentication returns undefined", async () => {
		const fakePasskeyOption = {
			challenge: "test-challenge",
			rpId: "test-rp",
		};
		...
		const fetchSpyPost = vi.spyOn(global, "fetch");
	...
	test("handleVerifyPasskey calls onSubmitError when startAuthentication fails", async () => {
		const fakePasskeyOption = {
			challenge: "test-challenge",
			rpId: "test-rp",
		};
	...
	test("handleVerifyPasskey calls onSubmitError when submitPasskey fails", async () => {
		const fakePasskeyOption = {
			challenge: "test-challenge",
			rpId: "test-rp",
		};
		...
		const fetchSpyPost = vi.spyOn(global, "fetch").mockRejectedValueOnce(error);
	...
	test("isVerifyingPasskey is set to true during verification and false after", async () => {
		const fakePasskeyOption = {
			challenge: "test-challenge",
			rpId: "test-rp",
		};
		...
		vi.spyOn(requestModule, "handleAuthorizeStep").mockImplementation(() => {});
