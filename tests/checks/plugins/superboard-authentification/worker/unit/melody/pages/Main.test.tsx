...
import { typeConfig } from "../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/configs";
import * as hooks from "../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/hooks";
import Main from "../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/Main";
import {
	acceptInvitation,
	authCodeExpired,
	changeEmail,
...
vi.mock("pages/hooks", async (importOriginal) => {
...
describe("App Component", () => {
	...
	it("renders Layout with correct props", () => {
	...
	it("renders ChangePassword view", () => {
		(hooks.useCurrentView as Mock).mockReturnValue({
	...
	it("renders ManageRecoveryCode view", () => {
		(hooks.useCurrentView as Mock).mockReturnValue({
	...
	it("renders PasswordlessVerify view", () => {
		(hooks.useCurrentView as Mock).mockReturnValue({
	...
	it("renders AuthCodeExpired view", () => {
		(hooks.useCurrentView as Mock).mockReturnValue({
	...
	it("renders RecoveryCodeEnroll view", () => {
		(hooks.useCurrentView as Mock).mockReturnValue({
	...
	it("renders RecoveryCodeSignIn view", () => {
		(hooks.useCurrentView as Mock).mockReturnValue({
	...
	it("renders AcceptInvitation view", () => {
		(hooks.useCurrentView as Mock).mockReturnValue({
	...
	it("shows locale selector when enabled", () => {
		const container = document.getElementById("root")!;
		render(<Main />, container);
	...
	it("hides locale selector when disabled", () => {
