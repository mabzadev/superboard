...
import useChangeEmailForm from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/hooks/useChangeEmailForm";
...
test("calls onSubmitError when resend code fails", async () => {
	const onSubmitError = vi.fn();
