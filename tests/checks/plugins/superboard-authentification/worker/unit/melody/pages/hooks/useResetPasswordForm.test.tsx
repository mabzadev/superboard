...
import useResetPasswordForm from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/hooks/useResetPasswordForm";
...
test("handleSubmit calls onSubmitError when sending reset code fails (mfaCode === null)", async () => {
	const onSubmitError = vi.fn();
	const { result } = renderHook(() =>
		useResetPasswordForm({
			locale: "en",
...
test("handleSubmit calls onSubmitError when resetting password fails (mfaCode provided)", async () => {
	const onSubmitError = vi.fn();
	const { result } = renderHook(() =>
		useResetPasswordForm({
			locale: "en",
