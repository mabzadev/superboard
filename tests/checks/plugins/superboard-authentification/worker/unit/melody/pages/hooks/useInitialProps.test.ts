...
import useInitialProps from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/hooks/useInitialProps";

describe("useInitialProps", () => {
	// Ensure __initialProps is reset before each test
	beforeEach(() => {
		delete (window as any).__initialProps;
	});

	test("returns default values when window.__initialProps is not defined", () => {
	...
	test("returns values from window.__initialProps when defined", () => {
	...
	test("returns default values for missing logoUrl and locales when window.__initialProps exists", () => {
