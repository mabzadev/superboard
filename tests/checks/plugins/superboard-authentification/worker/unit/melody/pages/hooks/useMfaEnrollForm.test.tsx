...
import { MfaType } from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/models/user";
// Import the hook to test.
import { View } from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/hooks/useCurrentView";
import useMfaEnrollForm from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/hooks/useMfaEnrollForm";
...
test("getMfaEnrollInfo successfully fetches and updates mfaEnrollInfo", async () => {
	...
	expect(fetchSpy).toHaveBeenCalledWith(`${routeConfig.IdentityRoute.ProcessMfaEnroll}${qs}`, {
		method: "GET",
		headers: {
...
test("handleEnroll submits enrollment and calls handleAuthorizeStep for success response", async () => {
	...
	expect(fetchSpy).toHaveBeenCalledWith(routeConfig.IdentityRoute.ProcessMfaEnroll, {
		method: "POST",
		headers: {
			Accept: "application/json",
			"Content-Type": "application/json",
