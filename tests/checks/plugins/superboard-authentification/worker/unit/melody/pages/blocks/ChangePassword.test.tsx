...
import ChangePassword, {
	ChangePasswordProps,
} from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/blocks/ChangePassword";
import { changePassword } from "../../../../../../../../../packages/plugins/superboard-authentification/worker/src/melody/pages/tools/locale";
...
describe("ChangePassword Component", () => {
	...
	const setup = (props = defaultProps) => {
		...
		render(<ChangePassword {...props} />, container);
	...
	it("redirect link has correct href and text", () => {
		const container = setup();
	...
	it("calls handleSubmit when submit button is clicked", () => {
		...
		const submitButton = getByText(container, changePassword.confirm.en);
		expect(submitButton).toBeDefined();
	...
	it("calls handleChange when password input changes", () => {
		...
		if (passwordInput) {
			...
			expect(defaultProps.onChange).toHaveBeenCalledWith("password", "newpassword");
		}
	});
	...
	it("calls handleChange when confirm password input changes", () => {
		...
		if (confirmPasswordInput) {
			...
			expect(defaultProps.onChange).toHaveBeenCalledWith("confirmPassword", "newpassword");
		}
	});
});
