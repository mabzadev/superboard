...
import { prepareFollowUpBody, insertUsers } from "tests/identity";
...
describe("get /process-mfa-enroll", () => {
	...
	test("should throw error if user already enrolled", async () => {
		await insertUsers(db, false);
...
describe("post /process-mfa-enroll", () => {
