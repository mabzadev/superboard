...
describe("get /authorize-passkey-enroll", () => {
	test("should get enrollment options", async () => {
...
describe("post /authorize-passkey-enroll", () => {
	...
	test("should throw error if return wrong challenge", async () => {
		...
		await mockedKV.put(`${adapterConfig.BaseKVKey.PasskeyEnrollChallenge}-1`, "abcde");
...
describe("post /authorize-passkey-enroll-decline", () => {
	test("should skip passkey enroll", async () => {
		...
		await app.request(`${routeConfig.IdentityRoute.ProcessPasskeyEnroll}${params}`, {}, mock(db));
