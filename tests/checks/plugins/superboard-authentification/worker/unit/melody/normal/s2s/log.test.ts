...
import { mockedKV, migrate, mock } from "tests/mock";
...
describe("get all emailLogs", () => {
	test("should return all emailLogs", async () => {
	...
	test("could get email logs by pagination", async () => {
		await insertEmailLogs();
	...
	test("should not return log with non root scope", async () => {
		await insertEmailLogs();
...
describe("delete email logs", () => {
	test("should delete all email logs", async () => {
		await insertEmailLogs();
	...
	test("should delete email logs before a certain date", async () => {
		await insertEmailLogs();
	...
	test("should return 400 when before is not a valid utc string", async () => {
		await insertEmailLogs();
		await attachIndividualScopes(db);
...
describe("get emailLog by id", () => {
	test("should return emailLog by id 1", async () => {
		await insertEmailLogs();
	...
	test("should return emailLog by id 2", async () => {
		await insertEmailLogs();
	...
	test("should return 404 when can not find email log by id", async () => {
		const res = await app.request(
			`${BaseRoute}/email/6`,
			{ headers: { Authorization: `Bearer ${await getS2sToken(db)}` } },
			mock(db),
...
describe("get all smsLogs", () => {
	test("should return all smsLogs", async () => {
		await insertSmsLogs();
	...
	test("could get sms logs by pagination", async () => {
		await insertSmsLogs();
...
describe("delete sms logs", () => {
	test("should delete all sms logs", async () => {
		await insertSmsLogs();
	...
	test("should delete sms logs before a certain date", async () => {
		await insertSmsLogs();
...
describe("get smsLog by id", () => {
	test("should return smsLog by id 1", async () => {
		await insertSmsLogs();
	...
	test("should return smsLog by id 2", async () => {
		await insertSmsLogs();
	...
	test("should return 404 when can not find sms log by id", async () => {
		const res = await app.request(
			`${BaseRoute}/sms/6`,
			{ headers: { Authorization: `Bearer ${await getS2sToken(db)}` } },
			mock(db),
...
describe("get all signInLogs", () => {
	test("should return all signInLogs", async () => {
	...
	test("could get sign-in logs by pagination", async () => {
		await insertSignInLogs();
...
describe("delete sign-in logs", () => {
	test("should delete all sign-in logs", async () => {
		await insertSignInLogs();
	...
	test("should delete sign-in logs before a certain date", async () => {
		await insertSignInLogs();
	...
	test("should return 401 when before is not a valid time string", async () => {
		await insertSignInLogs();
		await attachIndividualScopes(db);
...
describe("get signInLog by id", () => {
	test("should return signInLog by id 1", async () => {
		await insertSignInLogs();
	...
	test("should return signInLog by id 2", async () => {
		await insertSignInLogs();
	...
	test("should return 404 when can not find sign-in log by id", async () => {
		const res = await app.request(
			`${BaseRoute}/sign-in/6`,
			{ headers: { Authorization: `Bearer ${await getS2sToken(db)}` } },
			mock(db),
