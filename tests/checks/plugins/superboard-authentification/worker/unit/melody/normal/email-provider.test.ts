...
describe("post /reset-password-code", () => {
	test("should send reset code by Sendgrid", async () => {
		...
		const { res, code } = await sendCorrectResetPasswordCodeReq();
	...
	test("should send email to dev in dev env", async () => {
	...
	test("could send reset code by Mailgun", async () => {
	...
	test("could log email by Mailgun", async () => {
		process.env.SENDGRID_API_KEY = "";
		process.env.SENDGRID_SENDER_ADDRESS = "";
		process.env.MAILGUN_API_KEY = "abc";
		process.env.MAILGUN_SENDER_ADDRESS = "app@valuemelody.com";
	...
	test("could send reset code by Brevo", async () => {
		process.env.SENDGRID_API_KEY = "";
		process.env.SENDGRID_SENDER_ADDRESS = "";
		process.env.BREVO_API_KEY = "abc";
		process.env.BREVO_SENDER_ADDRESS = "app@valuemelody.com";
	...
	test("could log email by Brevo", async () => {
		process.env.SENDGRID_API_KEY = "";
		process.env.SENDGRID_SENDER_ADDRESS = "";
		process.env.BREVO_API_KEY = "abc";
		process.env.BREVO_SENDER_ADDRESS = "app@valuemelody.com";
	...
	test("could send reset code by Resend", async () => {
		process.env.SENDGRID_API_KEY = "";
		process.env.SENDGRID_SENDER_ADDRESS = "";
		process.env.MAILGUN_API_KEY = "";
		process.env.MAILGUN_SENDER_ADDRESS = "";
	...
	test("could log email by Resend", async () => {
		process.env.SENDGRID_API_KEY = "";
		process.env.SENDGRID_SENDER_ADDRESS = "";
		process.env.BREVO_API_KEY = "";
		process.env.BREVO_SENDER_ADDRESS = "";
	...
	test("could send reset code by Postmark", async () => {
		process.env.SENDGRID_API_KEY = "";
		process.env.SENDGRID_SENDER_ADDRESS = "";
	...
	test("could log email by Postmark", async () => {
		process.env.SENDGRID_API_KEY = "";
		process.env.SENDGRID_SENDER_ADDRESS = "";
		process.env.POSTMARK_API_KEY = "abc";
		process.env.POSTMARK_SENDER_ADDRESS = "app@valuemelody.com";
	...
	test("could send reset code by smtp", async () => {
		process.env.MAILGUN_API_KEY = "abc";
		process.env.MAILGUN_SENDER_ADDRESS = "app@valuemelody.com";
		process.env.BREVO_API_KEY = "abc";
		process.env.BREVO_SENDER_ADDRESS = "app@valuemelody.com";
	...
	test("should stop after reach threshold", async () => {
		...
		expect(json).toStrictEqual({ success: true });
		expect(
			await mockedKV.get(`${adapterConfig.BaseKVKey.PasswordResetAttempts}-test@email.com`),
		).toBe("1");
		...
		const getPasswordResetAttemptsByIPSpy = vi.spyOn(kvService, "getPasswordResetAttemptsByIP");
		const setPasswordResetAttemptsByIPSpy = vi.spyOn(kvService, "setPasswordResetAttemptsByIP");
	...
	test("should throw error if no email config set", async () => {
...
describe("post /reset-password-code with EMAIL_PROVIDER_NAME", () => {
	test("should use SMTP when EMAIL_PROVIDER_NAME=smtp", async () => {
	...
	test("should use SendGrid when EMAIL_PROVIDER_NAME=sendgrid", async () => {
	...
	test("should use Mailgun when EMAIL_PROVIDER_NAME=mailgun", async () => {
	...
	test("should use Brevo when EMAIL_PROVIDER_NAME=brevo", async () => {
	...
	test("should use Resend when EMAIL_PROVIDER_NAME=resend", async () => {
	...
	test("should use Postmark when EMAIL_PROVIDER_NAME=postmark", async () => {
