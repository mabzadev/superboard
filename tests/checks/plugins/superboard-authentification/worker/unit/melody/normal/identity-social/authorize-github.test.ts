...
describe("get /authorize-github", () => {
	const mockGithubFetch = vi.fn(async (url, params) => {
	...
	test("should redirect to consent with a new GitHub account", async () => {
	...
	test("should redirect back to app with a new GitHub account when consent not need", async () => {
		global.process.env.GITHUB_AUTH_CLIENT_ID = "123";
		global.process.env.GITHUB_AUTH_CLIENT_SECRET = "abc";
		global.process.env.GITHUB_AUTH_APP_NAME = "app";
	...
	test("should be blocked if no app name provided in config", async () => {
		global.process.env.GITHUB_AUTH_CLIENT_SECRET = "abc";
		global.process.env.GITHUB_AUTH_CLIENT_ID = "123";
		const res = await prepareRequest();
		expect(res.status).toBe(400);
	...
	test("should sign in with an existing github account", async () => {
		global.process.env.GITHUB_AUTH_CLIENT_ID = "123";
		global.process.env.GITHUB_AUTH_CLIENT_SECRET = "abc";
		global.process.env.GITHUB_AUTH_APP_NAME = "app";
		const res = await getGitHubRequest();
