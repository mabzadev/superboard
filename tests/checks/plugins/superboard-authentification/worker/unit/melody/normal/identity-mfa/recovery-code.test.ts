...
describe("get /authorize-recovery-code-enroll", () => {
	test("should get recovery code", async () => {
	...
	test("should not get recovery code twice", async () => {
		process.env.ENABLE_RECOVERY_CODE = true as unknown as string;
		const { res } = await sendCorrectGetRecoveryCodeReq();
...
describe("post /authorize-recovery-code-enroll", () => {
	...
	test("should throw error if wrong code used", async () => {
		process.env.ENABLE_RECOVERY_CODE = true as unknown as string;
