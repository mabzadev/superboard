...
} from "../../../../packages/plugins/superboard-authentification/scripts/generate-identity-keyset.mjs";
...
test("identity keys cannot be written into the repository", () => {
	...
	assert.equal(
		assertSafeOutputPath("/tmp/superboard-identity-keyset.json"),
		"/tmp/superboard-identity-keyset.json",
	);
});
