...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-core/api/src/lib/account-erasure",
	async (load) => ({
		...(await load<
			typeof import("../../../../../../../packages/plugins/supbrd-core/api/src/lib/account-erasure")
		>()),
		eraseApplicationAccount: mocks.eraseApplicationAccount,
	}),
);

import accountSdk from "../../../../../../../packages/plugins/supbrd-core/api/src/routes/account-sdk";
