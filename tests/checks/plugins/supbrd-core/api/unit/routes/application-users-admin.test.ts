...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-core/api/src/lib/domain-modules",
	async (load) => ({
		...(await load<
			typeof import("../../../../../../../packages/plugins/supbrd-core/api/src/lib/domain-modules")
		>()),
		resolveAuthorizedProjectContext: mocks.resolveAuthorizedProjectContext,
	}),
);

import applicationUsersAdminRoutes from "../../../../../../../packages/plugins/supbrd-core/api/src/routes/application-users-admin";
