...
import type {
	AppVariables,
	Env,
} from "../../../../../../../packages/plugins/supbrd-core/api/src/types";
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-core/api/src/lib/billing-service",
	async (importOriginal) => {
		const original =
			await importOriginal<
				typeof import("../../../../../../../packages/plugins/supbrd-core/api/src/lib/billing-service")
			>();
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-core/api/src/lib/device-certification",
	async (importOriginal) => {
		const original =
			await importOriginal<
				typeof import("../../../../../../../packages/plugins/supbrd-core/api/src/lib/device-certification")
			>();
		return { ...original, recordDeviceCertificationResult: mocks.recordResult };
	},
);

import purchasesV2Sdk from "../../../../../../../packages/plugins/supbrd-core/api/src/routes/purchases-v2-sdk";
