...
} from "../../../../../../../packages/plugins/supbrd-core/api/src/lib/google-voided-purchases";
import type { BillingEnv } from "../../../../../../../packages/plugins/supbrd-core/api/src/types";
...
vi.mock("../../../../../../../packages/plugins/supbrd-core/api/src/lib/store-verification", () => ({
	googlePlayAccess: providerMocks.access,
}));
vi.mock(
	"../../../../../../../packages/plugins/supbrd-core/api/src/lib/billing",
	async (loadOriginal) => ({
		...(await loadOriginal<
			typeof import("../../../../../../../packages/plugins/supbrd-core/api/src/lib/billing")
		>()),
