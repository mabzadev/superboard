...
import { flowWorkflowInstanceId } from "../../../../../../../packages/plugins/superboard-acquisition/flows/src/workflows/instance-id";
...
describe("flowWorkflowInstanceId", () => {
	it("creates a deterministic Cloudflare-safe ID for long Delay and maintenance keys", async () => {
		...
		expect(await flowWorkflowInstanceId("flows-maintenance", "11:1786636800000:purge")).toMatch(
