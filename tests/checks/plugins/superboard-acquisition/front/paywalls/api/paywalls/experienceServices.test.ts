...
vi.mock(
	"../../../../../../../../packages/plugins/superboard-acquisition/src/front/onboardings/transport.js",
	() => ({
...
vi.mock(
	"../../../../../../../../packages/plugins/superboard-acquisition/src/front/paywalls/transport.js",
	() => ({
		GET: requestMocks.get,
		POST: requestMocks.post,
		PUT: requestMocks.put,
...
import {
	...
	updateOnboarding,
} from "../../../../../../../../packages/plugins/superboard-acquisition/src/front/onboardings/api/onboardings/onboardingsService.js";
import {
	archivePaywall,
	...
	updatePaywall,
} from "../../../../../../../../packages/plugins/superboard-acquisition/src/front/paywalls/api/paywalls/paywallsService.js";
...
describe("canonical experience services", () => {
	...
	it("uses the canonical project-ref route for paywalls", async () => {
		...
		expect(requestMocks.get).toHaveBeenCalledWith("/api/v1/paywalls/projects/10-test");
	});
	...
	it("sends a versioned visual definition to the paywalls contract", async () => {
		const definition = {
			...
			components: [{ id: "heading", type: "heading" as const, props: { text: "Hello" } }],
			metadata: {},
		};
