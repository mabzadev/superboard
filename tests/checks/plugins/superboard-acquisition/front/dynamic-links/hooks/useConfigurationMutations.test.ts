...
} from "../../../../../../../packages/plugins/superboard-acquisition/src/front/dynamic-links/hooks/mutations/useConfigurationMutations.js";
import { renderHook, act } from "../../../../../packages/supbrd-front-ui/render.js";
import { createTestQueryClient } from "./query-test-utils.js";

vi.mock(
	"../../../../../../../packages/plugins/superboard-analytics/src/front/api/configurations/redirect/configRedirectService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/superboard-analytics/src/front/api/configurations/domains/configDomainsService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/superboard-core/src/front/settings/analytics/index.js",
	() => ({
		trackEvent: vi.fn(),
		EVENTS: {
...
} from "../../../../../../../packages/plugins/superboard-analytics/src/front/api/configurations/domains/configDomainsService.js";
import {
	setDefaultRedirectAPICall,
	setRedirectAPICall,
} from "../../../../../../../packages/plugins/superboard-analytics/src/front/api/configurations/redirect/configRedirectService.js";
import { trackEvent } from "../../../../../../../packages/plugins/superboard-core/src/front/settings/analytics/index.js";
