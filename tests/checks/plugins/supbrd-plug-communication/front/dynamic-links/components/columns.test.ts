...
describe("Revenue columns", () => {
	...
	it(
		"includes attributed revenue in link columns",
		async () => {
			const { getLinksTableColumns } =
				await import("../../../../../../../packages/plugins/supbrd-plug-communication/src/front/dynamic-links/components/dynamic_links/links/LinksTableColumns.js");
	...
	it(
		"includes revenue in campaign columns",
		async () => {
			const { createCampaignsTableColumns } =
				await import("../../../../../../../packages/plugins/supbrd-plug-communication/src/front/dynamic-links/components/dynamic_links/campaigns/CampaignsTableColumns.js");
