...
} from "../../../../../../../packages/plugins/supbrd-plug-communication/src/front/dynamic-links/hooks/mutations/useCampaignsMutations.js";
import { renderHook, act } from "../../../../../packages/supbrd-front-ui/render.js";
import { createTestQueryClient } from "./query-test-utils.js";

vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-communication/src/front/dynamic-links/api/campaigns/campaignsService.js",
	() => ({
...
} from "../../../../../../../packages/plugins/supbrd-plug-communication/src/front/dynamic-links/api/campaigns/campaignsService.js";
...
describe("useCampaignsMutations", () => {
	...
	describe("useCreateCampaignMutation", () => {
		...
		it("does not invalidate when projectId is undefined", async () => {
			...
			const { result } = renderHook(() => useCreateCampaignMutation(undefined), {
				wrapper: createWrapper(queryClient),
			});
	...
	describe("useUpdateCampaignMutation", () => {
		...
		it("does not invalidate when projectId is undefined", async () => {
			...
			const { result } = renderHook(() => useUpdateCampaignMutation(undefined), {
				wrapper: createWrapper(queryClient),
			});
	...
	describe("useArchiveCampaignMutation", () => {
		it("calls archiveCampaignAPICall with projectId and campaignId", async () => {
			...
			const { result } = renderHook(() => useArchiveCampaignMutation("proj-1"), {
				wrapper: createWrapper(queryClient),
			});
		...
		it("does not invalidate when projectId is undefined", async () => {
			...
			const { result } = renderHook(() => useArchiveCampaignMutation(undefined), {
				wrapper: createWrapper(queryClient),
			});
