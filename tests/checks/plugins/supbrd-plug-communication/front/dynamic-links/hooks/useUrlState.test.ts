...
import { useUrlState as useDynamicUrlState } from "../../../../../../../packages/plugins/supbrd-plug-communication/src/front/dynamic-links/hooks/useUrlState.js";
import { useUrlState as useMarketingUrlState } from "../../../../../../../packages/plugins/supbrd-plug-communication/src/front/marketing/hooks/useUrlState.js";

describe.each([
	["Dynamic Links", useDynamicUrlState],
	["Marketing", useMarketingUrlState],
] as const)("%s URL state", (_owner, useUrlState) => {
	beforeEach(() => {
