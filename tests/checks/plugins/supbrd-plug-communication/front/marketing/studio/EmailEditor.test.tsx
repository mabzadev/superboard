...
import { EmailEditor } from "../../../../../../../packages/plugins/supbrd-plug-communication/src/front/marketing/studio/EmailEditor.js";

vi.mock("@superboard/front-ui/context", () => ({ useFrontContext: () => ({ locale: "en" }) }));
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-communication/src/front/marketing/studio/service.js",
	() => ({
