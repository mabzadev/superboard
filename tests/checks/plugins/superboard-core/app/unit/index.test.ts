import { signProjectContext, type InternalProjectContext } from "@superboard/contracts";
import { describe, expect, it } from "vitest";

import app from "../../../../../../packages/plugins/superboard-core/app/src/index";
...
function healthyDatabase(latestMigration: string, expectedApplied: boolean): D1Database {
	return {
