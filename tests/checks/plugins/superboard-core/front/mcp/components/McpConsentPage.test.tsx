...
vi.mock(
	"../../../../../../../packages/plugins/superboard-core/src/front/mcp/transport.js",
	() => registration,
);
...
vi.mock(
	"../../../../../../../packages/plugins/superboard-core/src/front/mcp/api/auth/userService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/superboard-core/src/front/mcp/api/mcp/mcpService.js",
	() => ({
...
vi.mock("../../../../../../../packages/supbrd-front-ui/src/shared/lib/ApiError.js", () => ({
...
import { currentUserAPICall } from "../../../../../../../packages/plugins/superboard-core/src/front/mcp/api/auth/userService.js";
import { approveConsentAPICall } from "../../../../../../../packages/plugins/superboard-core/src/front/mcp/api/mcp/mcpService.js";
import McpAuthorizePage from "../../../../../../../packages/plugins/superboard-core/src/front/mcp/app/mcp/authorize/page.js";
...
describe("McpAuthorizePage (consent)", () => {
	...
	it("shows API error message on approve failure", async () => {
		const { ApiError } =
			await import("../../../../../../../packages/supbrd-front-ui/src/shared/lib/ApiError.js");
