...
import admin from "../../../../../../../packages/plugins/superboard-core/api/src/routes/admin";
...
function testEnvironment(
	...
	const DB = createFakeD1((call: FakeD1Call) => {
		...
		if (call.sql.includes("FROM flows_legacy_cutover_state") && call.op === "first") {
			return routingState;
		}
	...
	return {
		environment: {
			DB,
			SUPERBOARD_CUTOVER_TOKEN: CUTOVER_TOKEN,
			FLOWS_MODULE: {
