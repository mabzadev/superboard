...
import { useNotificationsQuery } from "../../../../../../../packages/plugins/superboard-communication/src/front/marketing/hooks/queries/useNotificationsQueries.js";
...
vi.mock(
	"../../../../../../../packages/plugins/superboard-communication/src/front/marketing/api/notifications/notificationService.js",
	() => ({
		getNotificationsAPICall: vi.fn(),
	}),
);

import { getNotificationsAPICall } from "../../../../../../../packages/plugins/superboard-communication/src/front/marketing/api/notifications/notificationService.js";
