...
vi.mock(
	"../../../../../../../../packages/plugins/superboard-acquisition/src/front/dynamic-links/hooks/useUrlState.js",
	() => ({
		useUrlState: (_key: string, initial: string) => [initial, vi.fn()],
	}),
);
vi.mock(
	"../../../../../../../../packages/plugins/superboard-communication/src/front/marketing/hooks/queries/useNotificationsQueries.js",
	() => ({
...
vi.mock(
	"../../../../../../../../packages/plugins/superboard-communication/src/front/marketing/components/messaging/MessagingTableColumns.js",
	() => ({
		getMessagingTableColumns: () => [],
	}),
);
vi.mock(
	"../../../../../../../../packages/plugins/superboard-communication/src/front/marketing/components/messaging/MessagingTable.js",
	() => ({
		default: ({
			data,
			handleSelectRow,
...
vi.mock(
	"../../../../../../../../packages/plugins/superboard-communication/src/front/marketing/components/craft/DynamicEditor.js",
	() => ({
...
import InAppMessagesPage from "../../../../../../../../packages/plugins/superboard-communication/src/front/marketing/components/modules/InAppMessagesPage.js";

describe("Marketing In-app Messages parity", () => {
	it("requests the selected page size and exposes a page title", () => {
		render(<InAppMessagesPage />);
		expect(screen.getByRole("heading", { level: 1, name: "In-app messages" })).toBeInTheDocument();
		expect(queryCalls).toHaveBeenLastCalledWith(
			"10-test",
