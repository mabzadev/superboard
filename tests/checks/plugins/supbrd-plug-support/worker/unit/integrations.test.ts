...
describe("native Support integration contracts", () => {
	...
	it("accepts only provider-specific actions explicitly allowlisted in settings", () => {
		expect(
			validateNativeIntegrationSettings("slack", {
		...
		expect(
			validateNativeIntegrationSettings("linear", {
		...
		expect(
			validateNativeIntegrationSettings("notion", {
		...
		expect(
			validateNativeIntegrationSettings("shopify", {
