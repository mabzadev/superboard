...
import { claimSupportNotificationDeliveries } from "../../../../../../packages/plugins/supbrd-plug-support/worker/src/notifications";
...
describe("Support notification delivery outbox", () => {
    ...
    `)
			.bind(notificationId, authUserId)
			.run();
