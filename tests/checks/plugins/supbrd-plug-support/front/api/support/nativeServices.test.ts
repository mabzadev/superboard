...
} from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/captainService.js";
import {
	getSupportProviderCredentialStatus,
	listSupportChannels,
	saveSupportProviderCredentials,
} from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/channelsService.js";
import { publishSupportArticle } from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/helpCenterService.js";
import {
	saveSupportIntegrationCredentials,
	startSupportIntegrationOAuth,
} from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/integrationsService.js";
import {
	createSupportResource,
	deleteSupportResource,
	listSupportResource,
	updateSupportResource,
} from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/nativeClient.js";
import { getSupportOperationsHealth } from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/operationsHealthService.js";
import { runSupportCampaignAction } from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/proactiveService.js";
import {
	exportSupportReports,
	getSupportReports,
} from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/reportsService.js";
...
describe("native Support dashboard clients", () => {
	...
	it("keeps provider secrets write-only while exposing configuration state", async () => {
		...
		expect(api.GET).toHaveBeenNthCalledWith(1, "/api/v1/support/projects/project-1/channels");
