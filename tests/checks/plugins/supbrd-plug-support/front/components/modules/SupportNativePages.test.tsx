...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/settingsService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/operationsHealthService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/channelsService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/workforceService.js",
	() => ({
		listSupportInboxes: services.listInboxes,
	}),
);
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-support/src/front/api/support/operationsService.js",
	() => ({
...
import SupportChannelsPage from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/components/modules/SupportChannelsPage.js";
import SupportSettingsPage from "../../../../../../../packages/plugins/supbrd-plug-support/src/front/components/modules/SupportSettingsPage.js";
...
describe("native Support Grow pages", () => {
	...
	it("exposes native notification preferences and read-all controls", async () => {
		...
		await waitFor(() => expect(services.readAllNotifications).toHaveBeenCalledWith("project-1"));
	});
});
