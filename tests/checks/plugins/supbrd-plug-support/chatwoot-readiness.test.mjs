...
} from "../../../../packages/plugins/supbrd-plug-support/scripts/chatwoot-readiness.mjs";
...
test("Chatwoot readiness scans generated Flutter code even when Git ignores it", async (t) => {
	const root = mkdtempSync(join(tmpdir(), "superboard-chatwoot-client-"));
	...
	writeFileSync(
		...
		"const legacySupport = SupportChatWidget();\n",
	);
