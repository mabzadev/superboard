...
vi.mock(
	...
	() => ({
		useProjectSelection: () => ({ selectedProject: mocks.project }),
	}),
);

vi.mock("../../../../../../../packages/supbrd-front-ui/src/shared/hooks/useTableParams.js", () => {
	const parameters = {
		dateRange: {
	...
	return { useTableParams: () => parameters };
});

vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-analytics/src/front/api/app/appService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-analytics/src/front/api/dynamic-links/dynamicLinksService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-analytics/src/front/api/products/productsService.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-analytics/src/front/components/layout/section-cards.js",
	() => ({
...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-analytics/src/front/components/analytics/AnalyticsPages.js",
	() => ({
		AnalyticsPage: () => <section>Analytics overview</section>,
	}),
);
...
describe("DashboardPageContent", () => {
	beforeEach(() => {
		...
		mocks.accessKey.mockResolvedValue({
			id: "key-1",
			prefix: "og_app_test",
	...
	it("keeps available modules visible when one module fails", async () => {
		...
		expect(await screen.findByText("Customers: 120")).toBeInTheDocument();
		await waitFor(() =>
			expect(screen.getByText(/purchase analytics: Products unavailable/i)).toBeInTheDocument(),
		);
	});
});
