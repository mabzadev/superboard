...
vi.mock(
	"../../../../../../../packages/plugins/supbrd-plug-analytics/src/front/transport.js",
	() => api,
);
...
} from "../../../../../../../packages/plugins/supbrd-plug-analytics/src/front/api/analytics/analyticsService.js";
...
describe("Analytics dashboard service contracts", () => {
	...
	it("uses the project-scoped module gateway and unwraps responses", async () => {
		api.GET.mockResolvedValueOnce({
			data: {
				data: {
					events: 12,
					net_revenue_by_currency: [{ currency: "CHF", net_revenue_micros: 9_900_000 }],
				},
			},
		});
	...
	it("maps analysis, reports and durable operations without legacy routes", async () => {
		...
		expect(api.POST).toHaveBeenNthCalledWith(3, "/api/v1/analytics/projects/10-test/operations", {
			operation_type: "export",
			input: {},
		});
	});
