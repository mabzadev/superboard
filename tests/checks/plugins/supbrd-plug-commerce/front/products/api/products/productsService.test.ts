...
vi.mock(
	"../../../../../../../../packages/plugins/supbrd-plug-commerce/src/front/products/transport.js",
	() => ({
		GET: requests.get,
		POST: requests.post,
		PUT: requests.put,
...
import {
	...
	updateOffering,
	updatePackage,
} from "../../../../../../../../packages/plugins/supbrd-plug-commerce/src/front/products/api/products/productsService.js";
