...
vi.mock(
	"../../../../../../../../packages/plugins/supbrd-plug-journeys/src/front/onboardings/transport.js",
	() => ({
...
vi.mock(
	"../../../../../../../../packages/plugins/supbrd-plug-commerce/src/front/paywalls/transport.js",
	() => ({
		GET: requestMocks.get,
		POST: requestMocks.post,
		PUT: requestMocks.put,
...
import {
	...
	updatePaywall,
} from "../../../../../../../../packages/plugins/supbrd-plug-commerce/src/front/paywalls/api/paywalls/paywallsService.js";
import {
	deleteOnboarding,
	...
	updateOnboarding,
} from "../../../../../../../../packages/plugins/supbrd-plug-journeys/src/front/onboardings/api/onboardings/onboardingsService.js";
