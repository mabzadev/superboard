...
import type { PortableTextEditorProps } from "../../../../../packages/admin/src/components/PortableTextEditor";
import { PortableTextEditor } from "../../../../../packages/admin/src/components/PortableTextEditor";
...
vi.mock("../../../../../packages/admin/src/components/MediaPickerModal", () => ({
	MediaPickerModal: () => null,
}));

vi.mock("../../../../../packages/admin/src/components/SectionPickerModal", () => ({
	SectionPickerModal: ({
		open,
		onOpenChange,
		onSelect,
...
vi.mock("../../../../../packages/admin/src/components/editor/DragHandleWrapper", () => ({
	DragHandleWrapper: ({
		editor,
		onInsertBlock,
	}: {
...
vi.mock("../../../../../packages/admin/src/components/editor/ImageNode", async () => {
...
vi.mock("../../../../../packages/admin/src/components/editor/PluginBlockNode", async () => {
	const { Node } = await import("@tiptap/core");
