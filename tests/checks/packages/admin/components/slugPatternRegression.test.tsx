...
const { Sections } = await import("../../../../../packages/admin/src/components/Sections");
const { MenuList } = await import("../../../../../packages/admin/src/components/MenuList");
const { Widgets } = await import("../../../../../packages/admin/src/components/Widgets");
