...
import type {
	...
	BackupOverview,
	BackupSettings,
} from "../../../../../../packages/admin/src/lib/api/backups.js";
...
vi.mock("../../../../../../packages/admin/src/lib/api/backups.js", async () => {
	const actual = await vi.importActual("../../../../../../packages/admin/src/lib/api/backups.js");
	return {
		...actual,
...
const { BackupSettings } =
	await import("../../../../../../packages/admin/src/components/settings/BackupSettings.js");
