...
import type {
	...
	ApiTokenInfo,
	CreateApiTokenInput,
} from "../../../../../../packages/admin/src/lib/api/api-tokens.js";
...
vi.mock("../../../../../../packages/admin/src/lib/api/api-tokens.js", async () => {
	const actual = await vi.importActual(
		"../../../../../../packages/admin/src/lib/api/api-tokens.js",
	);
	return {
		...actual,
...
vi.mock("../../../../../../packages/admin/src/lib/api/plugins.js", async () => {
	const actual = await vi.importActual("../../../../../../packages/admin/src/lib/api/plugins.js");
	return {
		...actual,
...
const { ApiTokenSettings } =
	await import("../../../../../../packages/admin/src/components/settings/ApiTokenSettings.js");
