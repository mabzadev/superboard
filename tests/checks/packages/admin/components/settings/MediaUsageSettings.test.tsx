...
vi.mock("../../../../../../packages/admin/src/components/settings/BackToSettingsLink.js", () => ({
...
} = await import("../../../../../../packages/admin/src/lib/api/media-usage-activation.js");
const { MediaUsageSettings } =
	await import("../../../../../../packages/admin/src/components/settings/MediaUsageSettings.js");
