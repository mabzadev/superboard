...
import { SecuritySettings } from "../../../../../../packages/admin/src/components/settings/SecuritySettings";
import type { PasskeyInfo } from "../../../../../../packages/admin/src/lib/api";
...
vi.mock("../../../../../../packages/admin/src/components/auth/PasskeyRegistration", () => ({
	PasskeyRegistration: ({
		onError,
		onSuccess,
	}: {
