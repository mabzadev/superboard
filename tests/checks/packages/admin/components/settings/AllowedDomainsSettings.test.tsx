...
import { AllowedDomainsSettings } from "../../../../../../packages/admin/src/components/settings/AllowedDomainsSettings";
import type { AllowedDomain } from "../../../../../../packages/admin/src/lib/api";
