...
import type { EmailSettings as EmailSettingsData } from "../../../../../../packages/admin/src/lib/api/email-settings";
...
vi.mock("../../../../../../packages/admin/src/lib/api/email-settings", async () => {
	const actual = await vi.importActual(
		"../../../../../../packages/admin/src/lib/api/email-settings",
	);
	return {
		...actual,
...
const { EmailSettings } =
	await import("../../../../../../packages/admin/src/components/settings/EmailSettings");
