...
} from "../../../../../packages/admin/src/lib/api/plugins";
...
vi.mock("../../../../../packages/admin/src/lib/api/plugins", async () => {
	const actual = await vi.importActual("../../../../../packages/admin/src/lib/api/plugins");
	return {
		...actual,
...
const { PluginSettings } =
	await import("../../../../../packages/admin/src/components/PluginSettings");
