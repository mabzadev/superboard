...
import { CommentInbox } from "../../../../../packages/admin/src/components/comments/CommentInbox";
import type {
	AdminComment,
	CommentCounts,
} from "../../../../../packages/admin/src/lib/api/comments.js";
// @ts-ignore — compiled lingui catalog has no .d.ts
import { messages as enMessages } from "../../../../../packages/admin/src/locales/en/messages.mjs";
