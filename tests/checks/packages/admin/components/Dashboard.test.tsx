...
import type { AdminManifest } from "../../../../../packages/admin/src/lib/api";
import type { DashboardStats } from "../../../../../packages/admin/src/lib/api/dashboard";
...
vi.mock("../../../../../packages/admin/src/lib/api/dashboard", async () => {
	const actual = await vi.importActual("../../../../../packages/admin/src/lib/api/dashboard");
	return {
		...actual,
...
const { Dashboard } = await import("../../../../../packages/admin/src/components/Dashboard");
