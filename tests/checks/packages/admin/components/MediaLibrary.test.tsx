...
import { MediaLibrary } from "../../../../../packages/admin/src/components/MediaLibrary";
import type {
	LocalMediaItem,
	MediaFolder,
	MediaItem,
...
import { ApiResponseError, deleteMedia } from "../../../../../packages/admin/src/lib/api";
import {
	MEDIA_USAGE_ACTIVATION_QUERY_KEY,
	MEDIA_USAGE_PROGRESS_QUERY_KEY,
} from "../../../../../packages/admin/src/lib/api/media-usage-activation.js";
...
vi.mock("../../../../../packages/admin/src/lib/api/media-usage-activation.js", async () => {
	const actual = await vi.importActual<
		typeof import("../../../../../packages/admin/src/lib/api/media-usage-activation.js")
	>("../../../../../packages/admin/src/lib/api/media-usage-activation.js");
	return {
		...actual,
...
vi.mock("../../../../../packages/admin/src/lib/api/current-user.js", () => ({
...
describe("MediaLibrary", () => {
	...
	describe("local search and filter", () => {
		...
		it("does not make provider media draggable into local folders", async () => {
			const api = await import("../../../../../packages/admin/src/lib/api");
