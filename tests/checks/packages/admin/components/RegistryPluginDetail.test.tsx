...
import type {
	...
	RegistryPackageView,
	RegistryReleaseView,
} from "../../../../../packages/admin/src/lib/api/registry";
import { registryQueryPolicyKey } from "../../../../../packages/admin/src/lib/api/registry";
...
vi.mock("../../../../../packages/admin/src/lib/api/registry", async () => {
	const actual = await vi.importActual<
		typeof import("../../../../../packages/admin/src/lib/api/registry")
	>("../../../../../packages/admin/src/lib/api/registry");
	return {
		...actual,
...
vi.mock("../../../../../packages/admin/src/lib/api/plugins", () => ({
	fetchPlugins: vi.fn(async () => []),
}));

const { RegistryPluginDetail } =
	await import("../../../../../packages/admin/src/components/RegistryPluginDetail");
