...
import type { ContentEditorProps } from "../../../../../packages/admin/src/components/ContentEditor";
import {
	ContentSettingsPanel,
	SettingsActionBar,
	type ContentSettingsPanelProps,
	type SettingsActionBarProps,
} from "../../../../../packages/admin/src/components/ContentSettingsPanel";
import type { BlockSidebarPanel } from "../../../../../packages/admin/src/components/PortableTextEditor";
import type {
	AdminManifest,
	BylineSummary,
	ContentItem,
} from "../../../../../packages/admin/src/lib/api";
import type { ContentEditorPanelContext } from "../../../../../packages/admin/src/lib/content-editor-panels";
import {
	PluginAdminProvider,
	type PluginAdmins,
} from "../../../../../packages/admin/src/lib/plugin-context";
...
vi.mock("../../../../../packages/admin/src/components/RevisionHistory", () => ({
	RevisionHistory: () => <div data-testid="revision-history">Revision History</div>,
}));

vi.mock("../../../../../packages/admin/src/components/TaxonomySidebar", () => ({
...
vi.mock("../../../../../packages/admin/src/components/editor/DocumentOutline", () => ({
	DocumentOutline: () => <div data-testid="doc-outline">Outline</div>,
}));

vi.mock("../../../../../packages/admin/src/components/editor/ImageDetailPanel", () => ({
	ImageDetailPanel: () => <div data-testid="image-detail-panel">Image details</div>,
}));

vi.mock("../../../../../packages/admin/src/components/SeoPanel", () => ({
