...
import type { MarketplacePluginDetail as PluginDetailType } from "../../../../../packages/admin/src/lib/api/marketplace";
...
const { MarketplacePluginDetail } =
	await import("../../../../../packages/admin/src/components/MarketplacePluginDetail");
