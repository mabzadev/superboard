...
import {
	...
	createAdminRouter,
} from "../../../../packages/admin/src/router";
...
vi.mock("../../../../packages/admin/src/components/Shell", () => ({
...
vi.mock("../../../../packages/admin/src/components/ContentEditor", () => ({
	ContentEditor: ({
		item,
		onSave,
		onAutosave,
...
vi.mock("../../../../packages/admin/src/components/MediaLibrary", () => ({
	MediaLibrary: ({
		items,
		isLoading,
		onUpload,
