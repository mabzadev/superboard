...
import { compileUrlPattern } from "../../../../../../packages/core/src/schema/url-pattern.js";
...
describe("urlPattern", () => {
	...
	describe("schema registry", () => {
		...
		it("invalidates URL patterns across duplicated query modules", async () => {
			const firstQueryModule = await import("../../../../../../packages/core/src/query.js");
			...
			await db
				...
				.execute();
			vi.resetModules();
			const secondQueryModule = await import("../../../../../../packages/core/src/query.js");
