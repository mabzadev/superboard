...
import { ScheduledNotDueError } from "../../../../../packages/core/src/database/repositories/types.js";
import type { Database } from "../../../../../packages/core/src/database/types.js";
import { CURSOR_RAW_VALUES } from "../../../../../packages/core/src/loader.js";
import { encode } from "../../../../../packages/core/src/object-cache/codec.js";
import {
...
import { getEmDashCollection, getEmDashEntry } from "../../../../../packages/core/src/query.js";
...
describe("object cache: content read-through", () => {
	...
	it("invalidates the content cache when a field is created or deleted", async () => {
		const { handleSchemaFieldCreate, handleSchemaFieldDelete } =
			await import("../../../../../packages/core/src/api/handlers/schema.js");
		vi.mocked(getLiveCollection).mockResolvedValue({
			entries: mockEntries(),
			error: undefined,
			cacheHint: {},
