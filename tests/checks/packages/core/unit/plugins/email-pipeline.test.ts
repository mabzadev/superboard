...
import {
	...
	getDevEmails,
} from "../../../../../../packages/core/src/plugins/email-console.js";
import {
	EmailNotConfiguredError,
	EmailPipeline,
	EmailRecursionError,
} from "../../../../../../packages/core/src/plugins/email.js";
import { HookPipeline } from "../../../../../../packages/core/src/plugins/hooks.js";
import { PluginManager } from "../../../../../../packages/core/src/plugins/manager.js";
import type {
...
describe("definePlugin — email capabilities", () => {
	it("accepts email:send as a valid capability", async () => {
		const { definePlugin } =
			await import("../../../../../../packages/core/src/plugins/define-plugin.js");
