...
vi.mock("../../../../../../packages/core/src/astro/session-user.js", () => ({
	resolveSessionUser: vi.fn(async () => null),
}));

let onRequest: typeof import("../../../../../../packages/core/src/astro/middleware/auth.js").onRequest;

beforeAll(async () => {
	vi.stubEnv("DEV", false);
	({ onRequest } = await import("../../../../../../packages/core/src/astro/middleware/auth.js"));
});
