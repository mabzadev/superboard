...
vi.mock("../../../../../packages/core/src/loader.js", () => ({ getDb: vi.fn() }));

import { getComments } from "../../../../../packages/core/src/comments/query.js";
import { CommentReactionRepository } from "../../../../../packages/core/src/database/repositories/comment-reaction.js";
import { CommentRepository } from "../../../../../packages/core/src/database/repositories/comment.js";
...
import { getDb } from "../../../../../packages/core/src/loader.js";
import {
	__setObjectCacheBackendForTests,
	type ObjectCacheBackend,
} from "../../../../../packages/core/src/object-cache/index.js";
import { invalidateUrlPatternCache } from "../../../../../packages/core/src/query.js";
import { getCollectionInfo } from "../../../../../packages/core/src/schema/query.js";
...
describe("object cache: comments (getComments)", () => {
	...
	it("busts the comments cache when a reaction is toggled", async () => {
		const { handleReactionToggle } =
			await import("../../../../../packages/core/src/api/handlers/comment-reactions.js");
