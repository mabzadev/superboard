...
import { GET as mediaFileGet } from "../../../../../../packages/core/src/astro/routes/api/media/file/[...key].js";
import {
	DELETE as archiveDelete,
	GET as archiveGet,
} from "../../../../../../packages/core/src/astro/routes/api/settings/backups/archives/[name].js";
import { POST as archivesPost } from "../../../../../../packages/core/src/astro/routes/api/settings/backups/archives/index.js";
import { GET as exportGet } from "../../../../../../packages/core/src/astro/routes/api/settings/backups/export.js";
import {
	GET as backupsGet,
	PUT as backupsPut,
} from "../../../../../../packages/core/src/astro/routes/api/settings/backups/index.js";
