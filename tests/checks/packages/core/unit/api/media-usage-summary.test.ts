...
} from "../../../../../../packages/core/src/api/handlers/media-usage.js";
import {
	handleMediaGet,
	handleMediaList,
} from "../../../../../../packages/core/src/api/handlers/media.js";
import {
	mediaGetQuery,
	mediaListQuery,
...
} from "../../../../../../packages/core/src/api/schemas/index.js";
import { GET as listMedia } from "../../../../../../packages/core/src/astro/routes/api/media.js";
import { GET as getMediaItem } from "../../../../../../packages/core/src/astro/routes/api/media/[id].js";
import { runMigrations } from "../../../../../../packages/core/src/database/migrations/runner.js";
import { MediaUsageRepository } from "../../../../../../packages/core/src/database/repositories/media-usage.js";
import {
	MediaRepository,
	type MediaItem,
} from "../../../../../../packages/core/src/database/repositories/media.js";
import type { Database as DatabaseSchema } from "../../../../../../packages/core/src/database/types.js";
import {
	CONTENT_MEDIA_USAGE_ADAPTER_ID,
	CONTENT_MEDIA_USAGE_COLLECTION_SCOPE,
} from "../../../../../../packages/core/src/media/usage/content-refresh.js";
import { CONTENT_SOURCE_SCHEMA_VERSION } from "../../../../../../packages/core/src/media/usage/content-snapshots.js";
import { buildContentMediaUsageSourceKey } from "../../../../../../packages/core/src/media/usage/source-key.js";
