...
import type { Database as DbSchema } from "../../../../../../packages/core/src/database/types.js";
import type { SandboxRunner } from "../../../../../../packages/core/src/plugins/sandbox/types.js";
import { PluginStateRepository } from "../../../../../../packages/core/src/plugins/state.js";
import type { Storage } from "../../../../../../packages/core/src/storage/types.js";
...
describe("handleRegistryUpdate env gate", () => {
	...
	let handleRegistryInstall: typeof import("../../../../../../packages/core/src/api/handlers/registry.js").handleRegistryInstall;
	let handleRegistryUpdate: typeof import("../../../../../../packages/core/src/api/handlers/registry.js").handleRegistryUpdate;
	...
	beforeEach(async () => {
		({ handleRegistryInstall, handleRegistryUpdate } =
			await import("../../../../../../packages/core/src/api/handlers/registry.js"));
