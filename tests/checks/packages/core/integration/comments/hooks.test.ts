...
import { defaultCommentModerate } from "../../../../../../packages/core/src/comments/moderator.js";
import {
	createComment,
	moderateComment,
	type CommentHookRunner,
} from "../../../../../../packages/core/src/comments/service.js";
...
describe("Comment Hooks with HookPipeline", () => {
	...
	it("built-in moderator is auto-selected when sole provider", async () => {
		const { DEFAULT_COMMENT_MODERATOR_PLUGIN_ID } =
			await import("../../../../../../packages/core/src/comments/moderator.js");
