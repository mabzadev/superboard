...
type AdminRoute =
	typeof import("../../../../../../packages/core/src/astro/routes/api/setup/admin.js");
type AdminVerifyRoute =
	typeof import("../../../../../../packages/core/src/astro/routes/api/setup/admin-verify.js");
...
describe("POST /setup/admin/verify — success path clears nonce cookie", () => {
	...
	beforeEach(async () => {
		...
		({ POST: postAdmin } =
			await import("../../../../../../packages/core/src/astro/routes/api/setup/admin.js"));
		({ POST: postAdminVerify } =
			await import("../../../../../../packages/core/src/astro/routes/api/setup/admin-verify.js"));
	});
