...
} from "../../../../packages/gutenberg-to-portable-text/src/index.js";
import type {
...
} from "../../../../packages/gutenberg-to-portable-text/src/types.js";
			...
			const result = gutenbergToPortableText(content, {
				customTransformers: {
					"my-plugin/testimonial": (block, _opts, ctx) => [
						...
						} as unknown as import("../../../../packages/gutenberg-to-portable-text/src/types.js").PortableTextBlock,
					],
				},
			});
