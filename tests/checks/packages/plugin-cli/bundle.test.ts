...
import {
	...
	bundlePlugin,
	type PluginManifest,
} from "../../../../packages/plugin-cli/src/api.js";
import {
	probeAndAssemble,
	type ProbeAndAssembleContext,
	type ResolvedSources,
} from "../../../../packages/plugin-cli/src/build/pipeline.js";

const FIXTURE = fileURLToPath(
	new URL("../../../fixtures/plugin-cli/minimal-plugin", import.meta.url),
);
const BAD_FIXTURE = fileURLToPath(
	new URL("../../../fixtures/plugin-cli/bad-plugin", import.meta.url),
);
