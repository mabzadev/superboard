...
import {
	checkPublisher,
	writePublisherBack,
} from "../../../../packages/plugin-cli/src/manifest/publisher.js";
import {
	ManifestSchema,
	PublisherSchema,
} from "../../../../packages/plugin-cli/src/manifest/schema.js";
...
`;
		...
		// break JSONC).
		const { loadManifest } = await import("../../../../packages/plugin-cli/src/manifest/load.js");
