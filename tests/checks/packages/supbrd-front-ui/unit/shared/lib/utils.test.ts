...
import {
	...
	formatPlatformName,
} from "../../../../../../../packages/supbrd-front-ui/src/shared/lib/utils.js";
...
describe("parseSecondsInDaysHoursMinutesSeconds", () => {
	...
	it("handles days", () => {
		expect(parseSecondsInDaysHoursMinutesSeconds(86400)).toBe("1 day and 0 hours");
		expect(parseSecondsInDaysHoursMinutesSeconds(172800 + 7200)).toBe("2 days and 2 hours");
	});
});
